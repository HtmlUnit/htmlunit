...
![Commercial Users](https://api.scarf.sh/v2/packages/HTML-Unit/e4454d4c-c1a0-44d6-8af9-ab9ee18b428c/commercial-users-badge)
...
```groovy
implementation group: 'org.htmlunit', name: 'htmlunit', version: '5.4.0'
```
...
// ...
dependencies {
    implementation group: 'org.htmlunit', name: 'htmlunit', version: '5.5.0-SNAPSHOT'
  // ...
}
```
