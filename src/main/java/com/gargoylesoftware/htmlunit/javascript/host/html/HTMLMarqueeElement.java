 ...
 */
@JsxClasses({
    @JsxClass(domClass = HtmlMarquee.class, browsers = { @WebBrowser(value = IE, minVersion = 11) }),
    @JsxClass(domClass = HtmlMarquee.class, isJSObject = false, isDefinedInStandardsMode = true,
