...
public class AbstractList2 extends SimpleScriptObject {
    ...
    private AbstractList2(final DomNode domeNode, final boolean attributeChangeSensitive,
        ...
        if (domeNode != null) {
            ...
            if (parentScope != null) {
                final Global global = domeNode.getPage().getEnclosingWindow().getScriptableObject();
...
//            final AbstractList2 collection = new AbstractList2(getDomNodeOrDie(), matchingElements);
...
//        final DomNode domNode = getDomNodeOrNull();
//        final AbstractList2 collection = new AbstractList2(domNode, matchingElements);
...
//        return !(getPrototype() instanceof AbstractList2);
//    }
//
//    /**
...
//    }
    ...
    private static final class DomHtmlAttributeChangeListenerImpl
        ...
        private transient WeakReference<AbstractList2> nodeList_;

        private DomHtmlAttributeChangeListenerImpl(final AbstractList2 nodeList) {
            super();
        ...
        public void attributeReplaced(final HtmlAttributeChangeEvent event) {
            final AbstractList2 nodes = nodeList_.get();
            if (null == nodes) {
                return;
            }
     ...
     */
    protected ScriptObject getScriptObjectForElement(final Object object) {
