 ...
 */
@ScriptClass
public class Comment2 extends CharacterData2 {
     ...
     */
    public static Comment2 constructor(final boolean newObj, final Object self) {
        final Comment2 host = new Comment2();
    ...
    private static MethodHandle staticHandle(final String name, final Class<?> rtype, final Class<?>... ptypes) {
        try {
            return MethodHandles.lookup().findStatic(Comment2.class,
    ...
    public static final class FunctionConstructor extends ScriptFunction {
        ...
        public FunctionConstructor() {
            super("Comment",
                    staticHandle("constructor", Comment2.class, boolean.class, Object.class),
                    null);
