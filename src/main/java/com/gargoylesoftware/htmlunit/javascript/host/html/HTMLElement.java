 ...
 * @author Frank Danek
 */
@JsxClass(domClass = HtmlAbbreviated.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlAcronym.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlAddress.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlArticle.class)
@JsxClass(domClass = HtmlAside.class)
@JsxClass(domClass = HtmlBaseFont.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlBidirectionalIsolation.class, value = {CHROME, FF68})
@JsxClass(domClass = HtmlBidirectionalOverride.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlBig.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlBold.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlCenter.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlCitation.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlCode.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlDefinition.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlDefinitionDescription.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlDefinitionTerm.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlElement.class, value = {FF68, FF60, IE})
@JsxClass(domClass = HtmlEmphasis.class, value = {CHROME, FF68, FF60})
...
@JsxClass(domClass = HtmlItalic.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlKeyboard.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlLayer.class, value = CHROME)
@JsxClass(domClass = HtmlMark.class)
@JsxClass(domClass = HtmlNav.class)
@JsxClass(domClass = HtmlNoBreak.class, value = {CHROME, FF68, FF60})
...
@JsxClass(domClass = HtmlPlainText.class, value = {CHROME, FF68, FF60})
...
@JsxClass(domClass = HtmlS.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlSample.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlSection.class)
@JsxClass(domClass = HtmlSmall.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlStrike.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlStrong.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlSubscript.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlSummary.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlSuperscript.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlTeletype.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlUnderlined.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlWordBreak.class)
@JsxClass(domClass = HtmlMain.class, value = {CHROME, FF68, FF60})
@JsxClass(domClass = HtmlVariable.class, value = {CHROME, FF68, FF60})
