 ...
 */
@ScriptClass
public class HTMLTitleElement2 extends HTMLElement2 {
     ...
     */
    public static HTMLTitleElement2 constructor(final boolean newObj, final Object self) {
        final HTMLTitleElement2 host = new HTMLTitleElement2();
    ...
    private static MethodHandle staticHandle(final String name, final Class<?> rtype, final Class<?>... ptypes) {
        try {
            return MethodHandles.lookup().findStatic(HTMLTitleElement2.class,
    ...
    public static final class FunctionConstructor extends ScriptFunction {
        ...
        public FunctionConstructor() {
            super("HTMLTitleElement",
                    staticHandle("constructor", HTMLTitleElement2.class, boolean.class, Object.class),
                    null);
