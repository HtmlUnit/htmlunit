 ...
 */
@JsxClasses({
    @JsxClass(domClass = HtmlAbbreviated.class, isJSObject = false, browsers = @WebBrowser(value = IE, maxVersion = 8)),
    ...
    @JsxClass(domClass = HtmlCitation.class, isJSObject = false, browsers = @WebBrowser(value = IE, maxVersion = 8)),
    ...
    @JsxClass(domClass = HtmlDefinition.class, isJSObject = false, browsers = @WebBrowser(value = IE, maxVersion = 8)),
    @JsxClass(domClass = HtmlDefinition.class, browsers = @WebBrowser(value = IE, minVersion = 11)),
    @JsxClass(domClass = HtmlDeletedText.class,
        isJSObject = false, browsers = @WebBrowser(value = IE, maxVersion = 8)),
    @JsxClass(domClass = HtmlEmphasis.class, isJSObject = false, browsers = @WebBrowser(value = IE, maxVersion = 8)),
    ...
    @JsxClass(domClass = HtmlKeyboard.class, isJSObject = false, browsers = @WebBrowser(value = IE, maxVersion = 8)),
    ...
    @JsxClass(domClass = HtmlSubscript.class, isJSObject = false, browsers = @WebBrowser(value = IE, maxVersion = 8)),
    ...
    @JsxClass(domClass = HtmlTeletype.class, isJSObject = false, browsers = @WebBrowser(value = IE, maxVersion = 8)),
    @JsxClass(domClass = HtmlTeletype.class, browsers = @WebBrowser(value = IE, minVersion = 11)),
    @JsxClass(domClass = HtmlUnderlined.class, isJSObject = false, browsers = @WebBrowser(value = IE, maxVersion = 8)),
    @JsxClass(domClass = HtmlUnderlined.class, browsers = @WebBrowser(value = IE, minVersion = 11)),
    @JsxClass(domClass = HtmlVariable.class, isJSObject = false, browsers = @WebBrowser(value = IE, maxVersion = 8)),
