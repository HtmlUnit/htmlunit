 ...
 */
@ScriptClass
public class HTMLEmbedElement2 extends HTMLElement2 {
     ...
     */
    public static HTMLEmbedElement2 constructor(final boolean newObj, final Object self) {
        final HTMLEmbedElement2 host = new HTMLEmbedElement2();
    ...
    private static MethodHandle staticHandle(final String name, final Class<?> rtype, final Class<?>... ptypes) {
        try {
            return MethodHandles.lookup().findStatic(HTMLEmbedElement2.class,
    ...
    public static final class FunctionConstructor extends ScriptFunction {
        ...
        public FunctionConstructor() {
            super("HTMLEmbedElement",
                    staticHandle("constructor", HTMLEmbedElement2.class, boolean.class, Object.class),
                    null);
