 ...
 */
@ScriptClass
public class HTMLHtmlElement2 extends HTMLElement2 {
    ...
    private static MethodHandle staticHandle(final String name, final Class<?> rtype, final Class<?>... ptypes) {
        try {
            return MethodHandles.lookup().findStatic(HTMLHtmlElement2.class,
    ...
    public static final class FunctionConstructor extends ScriptFunction {
        ...
        public FunctionConstructor() {
            super("HTMLHtmlElement",
                    staticHandle("constructor", HTMLHtmlElement2.class, boolean.class, Object.class),
                    null);
