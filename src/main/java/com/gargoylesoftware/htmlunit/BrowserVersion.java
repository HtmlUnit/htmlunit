...
public final class BrowserVersion implements Serializable {
    ...
    /** Latest Edge */
    public static final BrowserVersion EDGE = new BrowserVersion(85, "Edge");
    ...
    static {
        ...
        EDGE.applicationVersion_ = "5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/"
                                        + EDGE.getBrowserVersionNumeric() + ".0.4147.125 Safari/537.36 Edg/"
                                        + EDGE.getBrowserVersionNumeric() + ".0.522.59";
        ...
        EDGE.htmlAcceptHeader_ = "text/html,application/xhtml+xml,application/xml;"
                                            + "q=0.9,image/avif,image/webp,image/apng,*/*;"
                                            + "q=0.8,application/signed-exchange;v=b3;q=0.9";
        EDGE.imgAcceptHeader_ = "image/avif,image/webp,image/apng,image/*,*/*;q=0.8";
