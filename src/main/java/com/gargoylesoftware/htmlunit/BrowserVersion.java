...
public final class BrowserVersion implements Serializable {
    ...
    static {
        ...
        FIREFOX_45.headerNamesOrdered_ = new String[] {
            "Host", "User-Agent", HttpHeader.ACCEPT, HttpHeader.ACCEPT_LANGUAGE, HttpHeader.ACCEPT_ENCODING, HttpHeader.REFERER, "Cookie", "Connection"};
        ...
        FIREFOX_52.headerNamesOrdered_ = new String[] {
            "Host", "User-Agent", HttpHeader.ACCEPT, HttpHeader.ACCEPT_LANGUAGE, HttpHeader.ACCEPT_ENCODING, HttpHeader.REFERER, "Cookie", "Connection", "Upgrade-Insecure-Requests"};
        ...
        INTERNET_EXPLORER.headerNamesOrdered_ = new String[] {
            HttpHeader.ACCEPT, HttpHeader.REFERER, HttpHeader.ACCEPT_LANGUAGE, "User-Agent", HttpHeader.ACCEPT_ENCODING, "Host", "DNT", "Connection",
            "Cookie"};
        ...
        CHROME.headerNamesOrdered_ = new String[] {
            "Host", "Connection", "Upgrade-Insecure-Requests", "User-Agent", HttpHeader.ACCEPT, HttpHeader.REFERER, HttpHeader.ACCEPT_ENCODING, HttpHeader.ACCEPT_LANGUAGE, "Cookie"};
