...
public final class BrowserVersion implements Serializable {
    ...
    /** Latest Edge */
    public static final BrowserVersion EDGE = new BrowserVersion(106, "Edge");

    /** Latest Chrome. */
    public static final BrowserVersion CHROME = new BrowserVersion(106, "Chrome");
    ...
    static {
        ...
        EDGE.applicationVersion_ = "5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/"
                                        ...
                                        + EDGE.getBrowserVersionNumeric() + ".0.1370.34";
