 ...
 * @author cd alexndr
 */
public class WrappedCssStyleDeclaration extends CssStyleDeclaration {
    ...
    public String getStyleAttribute(final Definition name1, final Definition name2) {
        final String value1 = cssStyleDeclarationImpl_.getPropertyValue(name1.getAttributeName());
        final String value2 = cssStyleDeclarationImpl_.getPropertyValue(name2.getAttributeName());
        ...
        return getStyleAttribute(name1, value2);
    }
}
