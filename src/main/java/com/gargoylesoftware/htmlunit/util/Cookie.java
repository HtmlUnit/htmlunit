...
public class Cookie implements Serializable {
    ...
    private final org.apache.hc.client5.http.cookie.Cookie httpClientCookie_;
    ...
    public Cookie(final String domain, final String name, final String value, final String path, final Date expires,
        ...
        cookie.setAttribute(org.apache.hc.client5.http.cookie.Cookie.DOMAIN_ATTR, domain);
