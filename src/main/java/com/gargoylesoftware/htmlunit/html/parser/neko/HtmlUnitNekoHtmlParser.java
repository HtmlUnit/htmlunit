...
public final class HtmlUnitNekoHtmlParser implements HTMLParser {
    ...
    public void parseFragment(final DomNode parent, final DomNode context, final String source)
        ...
        final NekoHtmlUnitDOMBuilder domBuilder = new NekoHtmlUnitDOMBuilder(this, parent, url, source);
    ...
    private void parse(final WebResponse webResponse, final WebWindow webWindow, final HtmlPage page,
        ...
        final NekoHtmlUnitDOMBuilder domBuilder = new NekoHtmlUnitDOMBuilder(this, page, url, null);
     ...
     */
    static final class NekoHtmlUnitDOMBuilder extends AbstractSAXParser
         ...
         */
        private NekoHtmlUnitDOMBuilder(final HTMLParser htmlParser,
