...
public final class JavaScriptConfiguration extends AbstractJavaScriptConfiguration {
    ...
    static final Class<? extends HtmlUnitScriptable>[] CLASSES_ = new Class[] {
        ...
        ClientRectList.class, Credential.class, CredentialsContainer.class, Crypto.class, CryptoKey.class,
        CustomElementRegistry.class, DOMError.class, DOMException.class, DOMImplementation.class,
        DOMMatrixReadOnly.class, DOMParser.class, DOMPointReadOnly.class, DOMRectReadOnly.class,
        DOMStringList.class, DOMStringMap.class, DOMTokenList.class, DataTransfer.class,
        DataTransferItem.class, DataTransferItemList.class, Event.class, EventTarget.class,
        External.class, FileList.class, FileSystem.class, FileSystemDirectoryReader.class,
        FileSystemEntry.class, FontFace.class, FormData.class, Gamepad.class, GamepadButton.class,
        Geolocation.class, GeolocationCoordinates.class, GeolocationPosition.class,
        GeolocationPositionError.class, HTMLOptionsCollection.class, Headers.class, History.class,
        ...
        MediaError.class, MediaKeyStatusMap.class, MediaKeySystemAccess.class, MediaKeys.class,
        MediaList.class, MessageChannel.class, MimeType.class, MimeTypeArray.class, MutationObserver.class,
        MutationRecord.class, NamedNodeMap.class, Navigator.class, NodeFilter.class, NodeIterator.class,
        Path2D.class, PaymentAddress.class, PerformanceEntry.class, PerformanceNavigation.class,
        PerformanceObserver.class, PerformanceObserverEntryList.class, PerformanceTiming.class,
        PeriodicSyncManager.class, PeriodicWave.class, Permissions.class, Plugin.class, PluginArray.class,
        Presentation.class, PushManager.class, PushSubscription.class, PushSubscriptionOptions.class,
        ...
        SVGAnimatedTransformList.class, SVGLength.class, SVGLengthList.class, SVGMatrix.class,
        ...
        TextEncoder.class, TextMetrics.class, TextTrackCueList.class, TimeRanges.class, Touch.class,
        TouchList.class, TreeWalker.class, URL.class, URLSearchParams.class, ValidityState.class,
        VideoPlaybackQuality.class, WebGL2RenderingContext.class, WebGLActiveInfo.class, WebGLBuffer.class,
        ...
        WebGLVertexArrayObject.class, WebkitSpeechGrammar.class, WebkitSpeechGrammarList.class,
        XMLSerializer.class, XPathEvaluator.class, XPathEvaluator.class, XPathExpression.class,
        ...
        CSSNamespaceRule.class, CSSPageRule.class, CSSStyleRule.class, CSSStyleSheet.class,
        ClipboardEvent.class, CloseEvent.class, ComputedCSSStyleDeclaration.class, CustomEvent.class,
        DOMMatrix.class, DOMPoint.class, DeviceMotionEvent.class, DeviceOrientationEvent.class,
        ErrorEvent.class, EventSource.class, FederatedCredential.class, File.class, FileReader.class,
        FileSystemDirectoryEntry.class, FileSystemFileEntry.class, FontFaceSet.class, GamepadEvent.class,
        HTMLCollection.class, HashChangeEvent.class, IDBCursorWithValue.class, IDBDatabase.class,
        IDBRequest.class, IDBTransaction.class, IDBVersionChangeEvent.class, MIDIAccess.class,
        MIDIConnectionEvent.class, MIDIMessageEvent.class, MIDIPort.class, MediaDevices.class,
        MediaEncryptedEvent.class, MediaKeyError.class, MediaKeyMessageEvent.class, MediaKeySession.class,
        MediaQueryList.class, MediaQueryListEvent.class, MediaRecorder.class, MediaSource.class, MediaStream.class,
        MediaStreamEvent.class, MediaStreamTrack.class, MediaStreamTrackEvent.class, MessageEvent.class,
        MessagePort.class, MutationEvent.class, NetworkInformation.class, Node.class, NodeList.class,
        Notification.class, OfflineAudioCompletionEvent.class, PageTransitionEvent.class, PasswordCredential.class,
        PaymentRequest.class, PaymentResponse.class, Performance.class, PerformanceMark.class,
        ...
        RTCPeerConnectionIceEvent.class, RTCSctpTransport.class, Range.class, RemotePlayback.class,
        Screen.class, ScreenOrientation.class, SecurityPolicyViolationEvent.class, ServiceWorker.class,
        ServiceWorkerContainer.class, ServiceWorkerRegistration.class, SharedWorker.class, SourceBuffer.class,
        SourceBufferList.class, SpeechSynthesis.class, SpeechSynthesisEvent.class, SpeechSynthesisUtterance.class,
        StorageEvent.class, SubmitEvent.class, TextTrack.class, TextTrackCue.class, TextTrackList.class,
        TimeEvent.class, TrackEvent.class, TransitionEvent.class, UIEvent.class, WebGLContextEvent.class,
        WebSocket.class, WebkitSpeechRecognition.class, WebkitSpeechRecognitionError.class,
        WebkitSpeechRecognitionEvent.class, Window.class, Worker.class, XMLHttpRequestEventTarget.class,
        // level 3
        AnalyserNode.class, Attr.class, AudioContext.class, AudioDestinationNode.class,
        AudioScheduledSourceNode.class, BiquadFilterNode.class, CSSConditionRule.class,
        CanvasCaptureMediaStream.class, CanvasCaptureMediaStreamTrack.class, ChannelMergerNode.class,
        ChannelSplitterNode.class, CharacterData.class, CompositionEvent.class, ConvolverNode.class,
        DelayNode.class, Document.class, DocumentFragment.class, DocumentType.class, DynamicsCompressorNode.class,
        Element.class, FocusEvent.class, GainNode.class, HTMLAllCollection.class, HTMLFormControlsCollection.class,
        IDBOpenDBRequest.class, IIRFilterNode.class, InputEvent.class, KeyboardEvent.class, MIDIInput.class,
        MIDIOutput.class, MediaElementAudioSourceNode.class, MediaStreamAudioDestinationNode.class,
        MediaStreamAudioSourceNode.class, MouseEvent.class, OfflineAudioContext.class, PannerNode.class,
        PerformanceNavigationTiming.class, RadioNodeList.class, ScriptProcessorNode.class,
        SpeechSynthesisErrorEvent.class, StereoPannerNode.class, TextEvent.class, TouchEvent.class,
        VTTCue.class, WaveShaperNode.class, XMLHttpRequest.class, XMLHttpRequestUpload.class,
        // level 4
        AudioBufferSourceNode.class, CSSMediaRule.class, CSSSupportsRule.class, Comment.class,
        ConstantSourceNode.class, DragEvent.class, HTMLDocument.class, HTMLElement.class, MouseScrollEvent.class,
        OscillatorNode.class, PointerEvent.class, ProcessingInstruction.class, SVGElement.class,
        ShadowRoot.class, Text.class, WheelEvent.class, XMLDocument.class,
        // level 5
        CDATASection.class, HTMLAnchorElement.class, HTMLAreaElement.class, HTMLBRElement.class,
        HTMLBaseElement.class, HTMLBodyElement.class, HTMLButtonElement.class, HTMLCanvasElement.class,
        HTMLDataElement.class, HTMLDataListElement.class, HTMLDetailsElement.class, HTMLDialogElement.class,
        HTMLDivElement.class, HTMLEmbedElement.class, HTMLFieldSetElement.class, HTMLFontElement.class,
        ...
        SVGFEDisplacementMapElement.class, SVGFEDistantLightElement.class, SVGFEDropShadowElement.class,
        SVGFEFloodElement.class, SVGFEGaussianBlurElement.class, SVGFEImageElement.class,
        ...
        SVGFESpotLightElement.class, SVGFETileElement.class, SVGFETurbulenceElement.class,
        SVGFilterElement.class, SVGGradientElement.class, SVGGraphicsElement.class, SVGMPathElement.class,
        SVGMarkerElement.class, SVGMaskElement.class, SVGMetadataElement.class, SVGPatternElement.class,
        SVGScriptElement.class, SVGStopElement.class, SVGStyleElement.class, SVGSymbolElement.class,
        SVGTitleElement.class, SVGViewElement.class,
        // level 6
        HTMLAudioElement.class, HTMLDListElement.class, HTMLDirectoryElement.class, HTMLMenuElement.class,
        HTMLOListElement.class, HTMLTableCellElement.class, HTMLTableColElement.class,
        HTMLTableElement.class, HTMLTableRowElement.class, HTMLTableSectionElement.class,
        HTMLUListElement.class, HTMLVideoElement.class, SVGAElement.class, SVGAnimateElement.class,
        SVGAnimateMotionElement.class, SVGAnimateTransformElement.class, SVGDefsElement.class,
        SVGDiscardElement.class, SVGFEFuncAElement.class, SVGFEFuncBElement.class, SVGFEFuncGElement.class,
        SVGFEFuncRElement.class, SVGForeignObjectElement.class, SVGGElement.class,
        SVGGeometryElement.class, SVGImageElement.class, SVGLinearGradientElement.class,
        SVGRadialGradientElement.class, SVGSVGElement.class, SVGSetElement.class, SVGSwitchElement.class,
        SVGTextContentElement.class, SVGUseElement.class,
        // level 7
        Audio.class, SVGCircleElement.class, SVGEllipseElement.class, SVGLineElement.class,
        SVGPathElement.class, SVGPolygonElement.class, SVGPolylineElement.class, SVGRectElement.class,
        SVGTextPathElement.class, SVGTextPositioningElement.class,
        // level 8
