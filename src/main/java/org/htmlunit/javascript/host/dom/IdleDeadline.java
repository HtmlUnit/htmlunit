 ...
 * @author Ronald Brill
 *
 * @see <a href="https://developer.mozilla.org/en-US/docs/Web/API/IdleDeadline">MDN Documentation</a>
 */
public class IdleDeadline extends HtmlUnitScriptable {
    ...
    public static final HtmlUnitClassDescriptor HTMLUNIT_DESCRIPTOR = new HtmlUnitClassDescriptor() {
        ...
        private static final ClassDescriptor DESCRIPTOR_ = new ClassDescriptor.Builder("IdleDeadline", 0,
