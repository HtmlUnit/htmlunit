 ...
 * @author Ronald Brill
 *
 * @see <a href="https://developer.mozilla.org/en-US/docs/Web/API/WebGL2RenderingContext">MDN Documentation</a>
 */
@JsxClass
public class WebGL2RenderingContext extends HtmlUnitScriptable {
