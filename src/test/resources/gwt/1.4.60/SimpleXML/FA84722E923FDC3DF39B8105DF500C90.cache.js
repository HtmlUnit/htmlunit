...
_=De.prototype=new Fe();_.tN=sA+'DOMImplOpera';_.tI=0;function Bf(a){bg=jb();return a;}
...
function ys(e,c){var a,d;try{return Cb(ur(us(e,c)),20);}catch(a){a=ec(a);if(Db(a,19)){d=a;throw sq(new rq(),c,d);}else throw a;}}
...
function Es(a,b){xs();return ts(it,a,b);}
...
function ls(){}
_=ls.prototype=new eu();_.tN=vA+'XMLParserImpl';_.tI=0;var it;function ss(){ss=nA;xs();}
...
function ps(){}
_=ps.prototype=new ls();_.tN=vA+'XMLParserImplStandard';_.tI=0;function os(){os=nA;ss();}
function ns(a){os();rs(a);return a;}
function ms(){}
_=ms.prototype=new ps();_.tN=vA+'XMLParserImplOpera';_.tI=0;function mt(){}
