...
function pi(b,a){qi();oi(b);b.a=a;nt(b.d,'<Please enter a method name above>');lt(b.d,true);ht(b.c,li(new ki(),b,a));nt(b.c,'red');ri(b,a);return b;}
function ri(f,d){var a,c,e;e=my(jt(f.c));if(!fy(e,f.b)){f.b=e;if(fy('',e)){nt(f.d,'<Please enter a method name above>');}else{try{c=Fh(si,e);nt(f.d,c);}catch(a){a=bh(a);if(wg(a,10)){a;nt(f.d,'<Not found>');}else throw a;}}}}
function ji(){}
...
function Ei(g,e,d){var a,c,f,h;tr(d,'');if(!fy('',g)){try{h=zB(new yB(),g);f=hc(this.a,h);tr(e,f);}catch(a){a=bh(a);if(wg(a,9)){a;c='Unable to parse input';tr(d,c);}else throw a;}}else{tr(e,'<None>');}}
function zi(){}
...
function hj(e){var a,b,c,d,f,g;c=di(new bi());b=Ar(new vr());for(d=fi(c).Bb().fb();d.eb();){a=vg(d.ib(),1);Dr(b,a);}f=qt(new et());g=qt(new et());fj(e,'constantsFirstNameCaption','First Name');ej(e,'constantsFirstNameText',f);fj(e,'constantsLastNameCaption','Last Name');ej(e,'constantsLastNameText',g);fj(e,'constantsFavoriteColorCaption','Favorite color');ej(e,'constantsFavoriteColorList',b);nt(f,'Amelie');nt(g,'Crutcher');}
...
function gk(g,e,d){var a,c,f,h;if(!fy('',g)){try{h=cw(g);f=Bd(this.a,h);tr(e,f);}catch(a){a=bh(a);if(wg(a,11)){a;c='Unable to parse input';tr(d,c);}else throw a;}}else{tr(e,'<None>');}}
function bk(){}
