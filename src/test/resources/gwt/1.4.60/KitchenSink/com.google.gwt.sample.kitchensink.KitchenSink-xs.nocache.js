function com_google_gwt_sample_kitchensink_KitchenSink(){
  ...
  function maybeStartModule(){
    if (gwtOnLoad && bodyDone) {
      gwtOnLoad(onLoadErrorFunc, 'com.google.gwt.sample.kitchensink.KitchenSink', base);
    }
  }

  function computeScriptBase(){
    var thisScript, markerScript;
    $doc.write('<script id="__gwt_marker_com.google.gwt.sample.kitchensink.KitchenSink"><\/script>');
    markerScript = $doc.getElementById('__gwt_marker_com.google.gwt.sample.kitchensink.KitchenSink');
    if (markerScript) {
  ...
  com_google_gwt_sample_kitchensink_KitchenSink.onScriptLoad = function(gwtOnLoadFunc){
