...
function Bd(d,b){var a,c;c=Fx(new Ex());if(mw(b)){cy(c,'NaN');return ky(c);}a=b<0.0||b==0.0&&1/b<0.0;cy(c,a?d.l:d.o);if(lw(b)){cy(c,'\u221E');}else{if(a){b= -b;}b*=d.k;if(d.q){Fd(d,b,c);}else{ae(d,b,c,d.j);}}cy(c,a?d.m:d.p);return ky(c);}
...
function ye(b){var a,c;a=vg(xD(b.a,'dateFormats'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['EEEE d MMMM yyyy','d MMMM yyyy','d MMM yy','dd/MM/yy']);b.a.vb('dateFormats',c);return c;}else return a;}
function ze(b){var a,c;a=vg(xD(b.a,'eraNames'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['av. J.-C.','ap. J.-C.']);b.a.vb('eraNames',c);return c;}else return a;}
function Ae(b){var a,c;a=vg(xD(b.a,'eras'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['av. J.-C.','apr. J.-C.']);b.a.vb('eras',c);return c;}else return a;}
...
function Ce(b){var a,c;a=vg(xD(b.a,'quarters'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['1er trimestre','2e trimestre','3e trimestre','4e trimestre']);b.a.vb('quarters',c);return c;}else return a;}
function De(b){var a,c;a=vg(xD(b.a,'shortMonths'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['janv.','f\xE9vr.','mars','avr.','mai','juin','juil.','ao\xFBt','sept.','oct.','nov.','d\xE9c.']);b.a.vb('shortMonths',c);return c;}else return a;}
function Ee(b){var a,c;a=vg(xD(b.a,'shortQuarters'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['T1','T2','T3','T4']);b.a.vb('shortQuarters',c);return c;}else return a;}
function Fe(b){var a,c;a=vg(xD(b.a,'shortWeekdays'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['dim.','lun.','mar.','mer.','jeu.','ven.','sam.']);b.a.vb('shortWeekdays',c);return c;}else return a;}
function af(b){var a,c;a=vg(xD(b.a,'standaloneMonths'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['janvier','f\xE9vrier','mars','avril','mai','juin','juillet','ao\xFBt','septembre','octobre','novembre','d\xE9cembre']);b.a.vb('standaloneMonths',c);return c;}else return a;}
...
function cf(b){var a,c;a=vg(xD(b.a,'standaloneNarrowWeekdays'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['D','L','M','M','J','V','S']);b.a.vb('standaloneNarrowWeekdays',c);return c;}else return a;}
function df(b){var a,c;a=vg(xD(b.a,'standaloneShortMonths'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['janv.','f\xE9vr.','mars','avr.','mai','juin','juil.','ao\xFBt','sept.','oct.','nov.','d\xE9c.']);b.a.vb('standaloneShortMonths',c);return c;}else return a;}
function ef(b){var a,c;a=vg(xD(b.a,'standaloneShortWeekdays'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['dim.','lun.','mar.','mer.','jeu.','ven.','sam.']);b.a.vb('standaloneShortWeekdays',c);return c;}else return a;}
function ff(b){var a,c;a=vg(xD(b.a,'standaloneWeekdays'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['dimanche','lundi','mardi','mercredi','jeudi','vendredi','samedi']);b.a.vb('standaloneWeekdays',c);return c;}else return a;}
function gf(b){var a,c;a=vg(xD(b.a,'timeFormats'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,["HH' h 'mm z",'HH:mm:ss z','HH:mm:ss','HH:mm']);b.a.vb('timeFormats',c);return c;}else return a;}
function hf(b){var a,c;a=vg(xD(b.a,'weekdays'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['dimanche','lundi','mardi','mercredi','jeudi','vendredi','samedi']);b.a.vb('weekdays',c);return c;}else return a;}
function te(){}
_=te.prototype=new vx();_.tN=eF+'DateTimeConstants_fr';_.tI=0;function kf(){}
_=kf.prototype=new vx();_.tN=eF+'NumberConstants_fr';_.tI=0;function DA(f,d,e){var a,b,c;for(b=f.E().hb();b.gb();){a=vg(b.kb(),8);c=a.bb();if(d===null?c===null:d.eQ(c)){if(e){b.wb();}return a;}}return null;}
...
function Fh(d,b){var a,c;c=vg(xD(d.a,b),1);if(c!==null)return c;if(qy(b,'white')){a='Blanc';d.a.vb('white',a);return a;}if(qy(b,'grey')){a='Gris';d.a.vb('grey',a);return a;}if(qy(b,'black')){a='Noir';d.a.vb('black',a);return a;}if(qy(b,'red')){a='Rouge';d.a.vb('red',a);return a;}if(qy(b,'green')){a='Vert';d.a.vb('green',a);return a;}if(qy(b,'yellow')){a='Jaune';d.a.vb('yellow',a);return a;}if(qy(b,'lightGrey')){a='Gris clair';d.a.vb('lightGrey',a);return a;}if(qy(b,'blue')){a='Bleu';d.a.vb('blue',a);return a;}throw AE(new zE(),"Cannot find constant '"+b+"'; expecting a method name",'com.google.gwt.sample.i18n.client.ColorConstants',b);}
function Bh(){}
_=Bh.prototype=new vx();_.tN=hF+'ColorConstants_fr';_.tI=0;function ci(a){a.a=tD(new BC());}
function di(a){ci(a);return a;}
function fi(b){var a;a=vg(xD(b.a,'colorMap'),5);if(a===null){a=Ef(new mf());a.vb('red','Rouge');a.vb('white','Blanc');a.vb('yellow','Jaune');a.vb('black','Noir');a.vb('blue','Bleu');a.vb('green','Vert');a.vb('grey','Gris');a.vb('lightGrey','Gris clair');b.a.vb('colorMap',a);}return a;}
function bi(){}
_=bi.prototype=new vx();_.tN=hF+'ConstantsExampleConstants_fr';_.tI=0;function hi(){}
_=hi.prototype=new vx();_.tN=hF+'ConstantsWithLookupExampleConstants_fr';_.tI=0;function qi(){qi=bF;si=Dh(new Bh());}
function oi(a){a.c=xt(new lt());a.d=xt(new lt());}
function pi(b,a){qi();oi(b);b.a=a;ut(b.d,'<Veuillez \xE9crire un nom de m\xE9thode ci-dessus> ');st(b.d,true);ot(b.c,li(new ki(),b,a));ut(b.c,'red');ri(b,a);return b;}
function ri(f,d){var a,c,e;e=xy(qt(f.c));if(!qy(e,f.b)){f.b=e;if(qy('',e)){ut(f.d,'<Veuillez \xE9crire un nom de m\xE9thode ci-dessus> ');}else{try{c=Fh(si,e);ut(f.d,c);}catch(a){a=bh(a);if(wg(a,10)){a;ut(f.d,'<Non trouv\xE9>');}else throw a;}}}}
function ji(){}
...
function Ei(g,e,d){var a,c,f,h;Ar(d,'');if(!qy('',g)){try{h=eC(new dC(),g);f=hc(this.a,h);Ar(e,f);}catch(a){a=bh(a);if(wg(a,9)){a;c="Incapable d'analyser l'entr\xE9e";Ar(d,c);}else throw a;}}else{Ar(e,'<None>');}}
function zi(){}
_=zi.prototype=new fh();_.B=Ci;_.C=Di;_.D=Ei;_.tN=hF+'DateTimeFormatExampleController';_.tI=0;_.a=null;_.b=null;function cj(d,a,b,c){return "L'utilisateur '"+a+"' a un niveau de securit\xE9 '"+b+"', et ne peut acc\xE9der \xE0 '"+c+"'";}
function aj(){}
_=aj.prototype=new vx();_.tN=hF+'ErrorMessages_fr';_.tI=0;function fj(d,b,c){var a;a=Ek(b);if(a===null){throw DE(new CE(),b);}ql(a,c);}
function ej(c,a,d){var b;b=bt(a);if(b===null){throw DE(new CE(),a);}b.u();fo(b,d);}
function hj(e){var a,b,c,d,f,g;c=di(new bi());b=bs(new Cr());for(d=fi(c).Db().hb();d.gb();){a=vg(d.kb(),1);es(b,a);}f=xt(new lt());g=xt(new lt());fj(e,'constantsFirstNameCaption','Pr\xE9nom');ej(e,'constantsFirstNameText',f);fj(e,'constantsLastNameCaption','Nom ');ej(e,'constantsLastNameText',g);fj(e,'constantsFavoriteColorCaption','Coleur pr\xE9f\xE9r\xE9e');ej(e,'constantsFavoriteColorList',b);ut(f,'Amelie');ut(g,'Crutcher');}
...
_=pj.prototype=new vx();_.tN=hF+'MessagesExampleConstants_fr';_.tI=0;function yj(){yj=bF;Aj=new aj();}
...
function ak(b){var a;a=vg(xD(b.a,'numberFormatPatterns'),5);if(a===null){a=Ef(new mf());a.vb('decimal','D\xE9cimal');a.vb('currency','Mon\xE9taire');a.vb('scientific','Scientifique');a.vb('percent','Pourcentage');a.vb('custom','Personnalis\xE9');b.a.vb('numberFormatPatterns',a);}return a;}
function Cj(){}
_=Cj.prototype=new vx();_.tN=hF+'NumberFormatExampleConstants_fr';_.tI=0;function ck(b,a){th(b,'31415926535.897932',ak(a));b.b=a;return b;}
...
function gk(g,e,d){var a,c,f,h;if(!qy('',g)){try{h=nw(g);f=Bd(this.a,h);Ar(e,f);}catch(a){a=bh(a);if(wg(a,11)){a;c="Incapable d'analyser l'entr\xE9e";Ar(d,c);}else throw a;}}else{Ar(e,'<None>');}}
function bk(){}
...
function zn(e,d,b,f,a){var c=new ($wnd.Option)(b,f);if(a== -1||a>d.options.length-1){d.add(c,null);}else{d.add(c,d.options[a]);}}
