...
function Bd(d,b){var a,c;c=zx(new yx());if(gw(b)){Cx(c,'NaN');return ey(c);}a=b<0.0||b==0.0&&1/b<0.0;Cx(c,a?d.l:d.o);if(fw(b)){Cx(c,'\u221E');}else{if(a){b= -b;}b*=d.k;if(d.q){Fd(d,b,c);}else{ae(d,b,c,d.j);}}Cx(c,a?d.m:d.p);return ey(c);}
...
function ye(b){var a,c;a=vg(rD(b.a,'dateFormats'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['EEEE d MMMM yyyy','d MMMM yyyy','d MMM yy','dd/MM/yy']);b.a.vb('dateFormats',c);return c;}else return a;}
function ze(b){var a,c;a=vg(rD(b.a,'eraNames'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['av. J.-C.','ap. J.-C.']);b.a.vb('eraNames',c);return c;}else return a;}
function Ae(b){var a,c;a=vg(rD(b.a,'eras'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['av. J.-C.','apr. J.-C.']);b.a.vb('eras',c);return c;}else return a;}
...
function Ce(b){var a,c;a=vg(rD(b.a,'quarters'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['1er trimestre','2e trimestre','3e trimestre','4e trimestre']);b.a.vb('quarters',c);return c;}else return a;}
function De(b){var a,c;a=vg(rD(b.a,'shortMonths'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['janv.','f\xE9vr.','mars','avr.','mai','juin','juil.','ao\xFBt','sept.','oct.','nov.','d\xE9c.']);b.a.vb('shortMonths',c);return c;}else return a;}
function Ee(b){var a,c;a=vg(rD(b.a,'shortQuarters'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['T1','T2','T3','T4']);b.a.vb('shortQuarters',c);return c;}else return a;}
function Fe(b){var a,c;a=vg(rD(b.a,'shortWeekdays'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['dim.','lun.','mar.','mer.','jeu.','ven.','sam.']);b.a.vb('shortWeekdays',c);return c;}else return a;}
function af(b){var a,c;a=vg(rD(b.a,'standaloneMonths'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['janvier','f\xE9vrier','mars','avril','mai','juin','juillet','ao\xFBt','septembre','octobre','novembre','d\xE9cembre']);b.a.vb('standaloneMonths',c);return c;}else return a;}
...
function cf(b){var a,c;a=vg(rD(b.a,'standaloneNarrowWeekdays'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['D','L','M','M','J','V','S']);b.a.vb('standaloneNarrowWeekdays',c);return c;}else return a;}
function df(b){var a,c;a=vg(rD(b.a,'standaloneShortMonths'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['janv.','f\xE9vr.','mars','avr.','mai','juin','juil.','ao\xFBt','sept.','oct.','nov.','d\xE9c.']);b.a.vb('standaloneShortMonths',c);return c;}else return a;}
function ef(b){var a,c;a=vg(rD(b.a,'standaloneShortWeekdays'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['dim.','lun.','mar.','mer.','jeu.','ven.','sam.']);b.a.vb('standaloneShortWeekdays',c);return c;}else return a;}
function ff(b){var a,c;a=vg(rD(b.a,'standaloneWeekdays'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['dimanche','lundi','mardi','mercredi','jeudi','vendredi','samedi']);b.a.vb('standaloneWeekdays',c);return c;}else return a;}
function gf(b){var a,c;a=vg(rD(b.a,'timeFormats'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,["HH' h 'mm z",'HH:mm:ss z','HH:mm:ss','HH:mm']);b.a.vb('timeFormats',c);return c;}else return a;}
function hf(b){var a,c;a=vg(rD(b.a,'weekdays'),6);if(a===null){c=pg('[Ljava.lang.String;',58,1,['dimanche','lundi','mardi','mercredi','jeudi','vendredi','samedi']);b.a.vb('weekdays',c);return c;}else return a;}
function te(){}
_=te.prototype=new px();_.tN=EE+'DateTimeConstants_fr';_.tI=0;function kf(){}
_=kf.prototype=new px();_.tN=EE+'NumberConstants_fr';_.tI=0;function xA(f,d,e){var a,b,c;for(b=f.E().hb();b.gb();){a=vg(b.kb(),8);c=a.bb();if(d===null?c===null:d.eQ(c)){if(e){b.wb();}return a;}}return null;}
...
function Fh(d,b){var a,c;c=vg(rD(d.a,b),1);if(c!==null)return c;if(ky(b,'white')){a='Blanc';d.a.vb('white',a);return a;}if(ky(b,'grey')){a='Gris';d.a.vb('grey',a);return a;}if(ky(b,'black')){a='Noir';d.a.vb('black',a);return a;}if(ky(b,'red')){a='Rouge';d.a.vb('red',a);return a;}if(ky(b,'green')){a='Vert';d.a.vb('green',a);return a;}if(ky(b,'yellow')){a='Jaune';d.a.vb('yellow',a);return a;}if(ky(b,'lightGrey')){a='Gris clair';d.a.vb('lightGrey',a);return a;}if(ky(b,'blue')){a='Bleu';d.a.vb('blue',a);return a;}throw uE(new tE(),"Cannot find constant '"+b+"'; expecting a method name",'com.google.gwt.sample.i18n.client.ColorConstants',b);}
function Bh(){}
_=Bh.prototype=new px();_.tN=bF+'ColorConstants_fr';_.tI=0;function ci(a){a.a=nD(new vC());}
function di(a){ci(a);return a;}
function fi(b){var a;a=vg(rD(b.a,'colorMap'),5);if(a===null){a=Ef(new mf());a.vb('red','Rouge');a.vb('white','Blanc');a.vb('yellow','Jaune');a.vb('black','Noir');a.vb('blue','Bleu');a.vb('green','Vert');a.vb('grey','Gris');a.vb('lightGrey','Gris clair');b.a.vb('colorMap',a);}return a;}
function bi(){}
_=bi.prototype=new px();_.tN=bF+'ConstantsExampleConstants_fr';_.tI=0;function hi(){}
_=hi.prototype=new px();_.tN=bF+'ConstantsWithLookupExampleConstants_fr';_.tI=0;function qi(){qi=BE;si=Dh(new Bh());}
function oi(a){a.c=rt(new ft());a.d=rt(new ft());}
function pi(b,a){qi();oi(b);b.a=a;ot(b.d,'<Veuillez \xE9crire un nom de m\xE9thode ci-dessus> ');mt(b.d,true);it(b.c,li(new ki(),b,a));ot(b.c,'red');ri(b,a);return b;}
function ri(f,d){var a,c,e;e=ry(kt(f.c));if(!ky(e,f.b)){f.b=e;if(ky('',e)){ot(f.d,'<Veuillez \xE9crire un nom de m\xE9thode ci-dessus> ');}else{try{c=Fh(si,e);ot(f.d,c);}catch(a){a=bh(a);if(wg(a,10)){a;ot(f.d,'<Non trouv\xE9>');}else throw a;}}}}
function ji(){}
...
function yi(b){var a;a=vg(rD(b.a,'dateTimeFormatPatterns'),5);if(a===null){a=Ef(new mf());a.vb('fullDateTime','Date/Heure complets');a.vb('longDateTime','Date/Heure tr\xE8s d\xE9taill\xE9s');a.vb('mediumDateTime','Date/Heure d\xE9taill\xE9s');a.vb('shortDateTime','Date/Heure abr\xE9g\xE9s');a.vb('fullDate','Date compl\xE8te');a.vb('longDate','Date tr\xE8s d\xE9taill\xE9e');a.vb('mediumDate','Date d\xE9taill\xE9e');a.vb('shortDate','Date abr\xE9g\xE9e');a.vb('fullTime','Heure compl\xE8te');a.vb('longTime','Heure tr\xE8s d\xE9taill\xE9e');a.vb('mediumTime','Heure d\xE9taill\xE9e');a.vb('shortTime','Heure abr\xE9g\xE9e');a.vb('custom','Personnalis\xE9');b.a.vb('dateTimeFormatPatterns',a);}return a;}
function ui(){}
_=ui.prototype=new px();_.tN=bF+'DateTimeFormatExampleConstants_fr';_.tI=0;function Ai(b,a){th(b,'13 September 1999',yi(a));b.b=a;return b;}
...
function Ei(g,e,d){var a,c,f,h;ur(d,'');if(!ky('',g)){try{h=EB(new DB(),g);f=hc(this.a,h);ur(e,f);}catch(a){a=bh(a);if(wg(a,9)){a;c="Incapable d'analyser l'entr\xE9e";ur(d,c);}else throw a;}}else{ur(e,'<None>');}}
function zi(){}
_=zi.prototype=new fh();_.B=Ci;_.C=Di;_.D=Ei;_.tN=bF+'DateTimeFormatExampleController';_.tI=0;_.a=null;_.b=null;function cj(d,a,b,c){return "L'utilisateur '"+a+"' a un niveau de securit\xE9 '"+b+"', et ne peut acc\xE9der \xE0 '"+c+"'";}
function aj(){}
_=aj.prototype=new px();_.tN=bF+'ErrorMessages_fr';_.tI=0;function fj(d,b,c){var a;a=Ek(b);if(a===null){throw xE(new wE(),b);}ql(a,c);}
function ej(c,a,d){var b;b=Bs(a);if(b===null){throw xE(new wE(),a);}b.u();En(b,d);}
function hj(e){var a,b,c,d,f,g;c=di(new bi());b=Br(new wr());for(d=fi(c).Db().hb();d.gb();){a=vg(d.kb(),1);Er(b,a);}f=rt(new ft());g=rt(new ft());fj(e,'constantsFirstNameCaption','Pr\xE9nom');ej(e,'constantsFirstNameText',f);fj(e,'constantsLastNameCaption','Nom ');ej(e,'constantsLastNameText',g);fj(e,'constantsFavoriteColorCaption','Coleur pr\xE9f\xE9r\xE9e');ej(e,'constantsFavoriteColorList',b);ot(f,'Amelie');ot(g,'Crutcher');}
...
_=pj.prototype=new px();_.tN=bF+'MessagesExampleConstants_fr';_.tI=0;function yj(){yj=BE;Aj=new aj();}
...
function ak(b){var a;a=vg(rD(b.a,'numberFormatPatterns'),5);if(a===null){a=Ef(new mf());a.vb('decimal','D\xE9cimal');a.vb('currency','Mon\xE9taire');a.vb('scientific','Scientifique');a.vb('percent','Pourcentage');a.vb('custom','Personnalis\xE9');b.a.vb('numberFormatPatterns',a);}return a;}
function Cj(){}
_=Cj.prototype=new px();_.tN=bF+'NumberFormatExampleConstants_fr';_.tI=0;function ck(b,a){th(b,'31415926535.897932',ak(a));b.b=a;return b;}
...
function gk(g,e,d){var a,c,f,h;if(!ky('',g)){try{h=hw(g);f=Bd(this.a,h);ur(e,f);}catch(a){a=bh(a);if(wg(a,11)){a;c="Incapable d'analyser l'entr\xE9e";ur(d,c);}else throw a;}}else{ur(e,'<None>');}}
function bk(){}
...
function sn(e,d,b,f,a){var c=new ($wnd.Option)(b,f);if(a== -1||a>d.options.length-1){d.add(c,null);}else{d.add(c,d.options[a]);}}
