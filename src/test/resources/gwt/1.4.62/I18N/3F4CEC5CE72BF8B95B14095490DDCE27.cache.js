...
function pi(b,a){qi();oi(b);b.a=a;st(b.d,'<Veuillez \xE9crire un nom de m\xE9thode ci-dessus> ');qt(b.d,true);mt(b.c,li(new ki(),b,a));st(b.c,'red');ri(b,a);return b;}
function ri(f,d){var a,c,e;e=my(ot(f.c));if(!fy(e,f.b)){f.b=e;if(fy('',e)){st(f.d,'<Veuillez \xE9crire un nom de m\xE9thode ci-dessus> ');}else{try{c=Fh(si,e);st(f.d,c);}catch(a){a=bh(a);if(wg(a,10)){a;st(f.d,'<Non trouv\xE9>');}else throw a;}}}}
function ji(){}
...
function Ei(g,e,d){var a,c,f,h;yr(d,'');if(!fy('',g)){try{h=zB(new yB(),g);f=hc(this.a,h);yr(e,f);}catch(a){a=bh(a);if(wg(a,9)){a;c="Incapable d'analyser l'entr\xE9e";yr(d,c);}else throw a;}}else{yr(e,'<None>');}}
function zi(){}
...
function hj(e){var a,b,c,d,f,g;c=di(new bi());b=Fr(new Ar());for(d=fi(c).Bb().fb();d.eb();){a=vg(d.ib(),1);cs(b,a);}f=vt(new jt());g=vt(new jt());fj(e,'constantsFirstNameCaption','Pr\xE9nom');ej(e,'constantsFirstNameText',f);fj(e,'constantsLastNameCaption','Nom ');ej(e,'constantsLastNameText',g);fj(e,'constantsFavoriteColorCaption','Coleur pr\xE9f\xE9r\xE9e');ej(e,'constantsFavoriteColorList',b);st(f,'Amelie');st(g,'Crutcher');}
...
function gk(g,e,d){var a,c,f,h;if(!fy('',g)){try{h=cw(g);f=Bd(this.a,h);yr(e,f);}catch(a){a=bh(a);if(wg(a,11)){a;c="Incapable d'analyser l'entr\xE9e";yr(d,c);}else throw a;}}else{yr(e,'<None>');}}
function bk(){}
