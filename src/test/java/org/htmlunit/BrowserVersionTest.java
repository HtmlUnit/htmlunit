...
public class BrowserVersionTest {
    ...
    public void getBrowserVersionNumeric() {
        assertEquals(129, BrowserVersion.FIREFOX.getBrowserVersionNumeric());
        assertEquals(115, BrowserVersion.FIREFOX_ESR.getBrowserVersionNumeric());
        assertEquals(128, BrowserVersion.CHROME.getBrowserVersionNumeric());
        assertEquals(128, BrowserVersion.EDGE.getBrowserVersionNumeric());
    }
