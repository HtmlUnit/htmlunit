...
public class BrowserVersionTest {
    ...
    public void getBrowserVersionNumeric() {
        assertEquals(113, BrowserVersion.FIREFOX.getBrowserVersionNumeric());
        ...
        assertEquals(113, BrowserVersion.CHROME.getBrowserVersionNumeric());
        assertEquals(113, BrowserVersion.EDGE.getBrowserVersionNumeric());
    }
