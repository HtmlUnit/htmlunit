...
/**
 * Tests for {@link SpeechRecognitionErrorEvent}.
 *
 * @author Ronald Brill
 */
public class SpeechRecognitionErrorEventTest extends WebDriverTestCase {
    ...
    public void create_ctor() throws Exception {
        final String html = DOCTYPE_HTML
            ...
            + "  function test() {\n"
            + "    try {\n"
            + "      var event = new SpeechRecognitionErrorEvent('error');\n"
            + "      dump(event);\n"
            + "    } catch(e) { logEx(e) }\n"
            + "  }\n"
            + DUMP_EVENT_FUNCTION
    ...
    public void create_ctorWithoutType() throws Exception {
        final String html = DOCTYPE_HTML
            ...
            + "  function test() {\n"
            + "    try {\n"
            + "      var event = new SpeechRecognitionErrorEvent();\n"
            + "      dump(event);\n"
            + "    } catch(e) { logEx(e) }\n"
            + "  }\n"
            + DUMP_EVENT_FUNCTION
    ...
    public void create_ctorNumericType() throws Exception {
        final String html = DOCTYPE_HTML
            ...
            + "  function test() {\n"
            + "    try {\n"
            + "      var event = new SpeechRecognitionErrorEvent(42);\n"
            + "      dump(event);\n"
            + "    } catch(e) { logEx(e) }\n"
            + "  }\n"
            + DUMP_EVENT_FUNCTION
    ...
    public void create_ctorNullType() throws Exception {
        final String html = DOCTYPE_HTML
            ...
            + "  function test() {\n"
            + "    try {\n"
            + "      var event = new SpeechRecognitionErrorEvent(null);\n"
            + "      dump(event);\n"
            + "    } catch(e) { logEx(e) }\n"
            + "  }\n"
            + DUMP_EVENT_FUNCTION
    ...
    public void create_ctorUnknownType() throws Exception {
        final String html = DOCTYPE_HTML
            ...
            + "  function test() {\n"
            + "    try {\n"
            + "      var event = new SpeechRecognitionErrorEvent(unknown);\n"
            + "      dump(event);\n"
            + "    } catch(e) { logEx(e) }\n"
            + "  }\n"
            + DUMP_EVENT_FUNCTION
    ...
    public void create_ctorArbitraryType() throws Exception {
        final String html = DOCTYPE_HTML
            ...
            + "  function test() {\n"
            + "    try {\n"
            + "      var event = new SpeechRecognitionErrorEvent('HtmlUnitEvent');\n"
            + "      dump(event);\n"
            + "    } catch(e) { logEx(e) }\n"
            + "  }\n"
            + DUMP_EVENT_FUNCTION
    ...
    public void create_createEvent() throws Exception {
        final String html = DOCTYPE_HTML
            ...
            + "  function test() {\n"
            + "    try {\n"
            + "      var event = document.createEvent('SpeechRecognitionErrorEvent');\n"
            + "      dump(event);\n"
            + "    } catch(e) { logEx(e) }\n"
            + "  }\n"
            + DUMP_EVENT_FUNCTION
    ...
    public void inWindow() throws Exception {
        final String html = DOCTYPE_HTML
            ...
            + LOG_TITLE_FUNCTION
            + "    function test() {\n"
            + "      log('SpeechRecognitionErrorEvent' in window);\n"
            + "    }\n"
            + "  </script>\n"
            + "</head>\n"
            + "<body onload='test()'>\n"
