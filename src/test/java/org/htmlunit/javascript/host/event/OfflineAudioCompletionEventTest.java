...
/**
 * Tests for {@link OfflineAudioCompletionEvent}.
 *
 * @author Ronald Brill
 */
public class OfflineAudioCompletionEventTest extends WebDriverTestCase {
    ...
    public void inWindow() throws Exception {
        final String html = DOCTYPE_HTML
            ...
            + LOG_TITLE_FUNCTION
            + "    function test() {\n"
            + "      log('OfflineAudioCompletionEvent' in window);\n"
            + "    }\n"
            + "  </script>\n"
            + "</head>\n"
            + "<body onload='test()'>\n"
    ...
    public void create_createEvent() throws Exception {
        final String html = DOCTYPE_HTML
            ...
            + "  function test() {\n"
            + "    try {\n"
            + "      var event = document.createEvent('OfflineAudioCompletionEvent');\n"
            + "      dump(event);\n"
            + "    } catch(e) { logEx(e) }\n"
            + "  }\n"
            + DUMP_EVENT_FUNCTION
