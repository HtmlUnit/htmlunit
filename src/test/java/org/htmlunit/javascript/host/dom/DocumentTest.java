...
public class DocumentTest extends WebDriverTestCase {
     ...
     */
    @Test
    @Alerts(DEFAULT = {"[170]", "[186]", "[192-214]", "[216-246]", "[248-255]"},
            FF = {"[170]", "[181]", "[186]", "[192-214]", "[216-246]", "[248-255]"},
            FF_ESR = {"[170]", "[181]", "[186]", "[192-214]", "[216-246]", "[248-255]"})
    @HtmlUnitNYI(CHROME = {"[170]", "[181]", "[186]", "[192-214]", "[216-246]", "[248-255]"},
            EDGE = {"[170]", "[181]", "[186]", "[192-214]", "[216-246]", "[248-255]"})
    public void documentCreateElementValidTagNames256() throws Exception {
        final String html
            = "<html>\n"
            + "  <head>\n"
            + "    <script>\n"
     ...
     */
    @Test
    @Alerts(DEFAULT = {"[256-305]", "[308-318]", "[321-328]",
                       "[330-382]", "[384-451]", "[461-496]", "[500-687]", "[699-705]", "[880-883]",
                       "[886-887]", "[891-893]", "[895]", "[902]", "[904-906]", "[908]", "[910-929]",
                       "[931-975]", "[979-980]", "[983-999]"},
            FF = {"[256-305]", "[308-318]", "[321-328]",
                  "[330-382]", "[384-451]", "[461-496]", "[500-501]", "[506-535]", "[592-680]",
                  "[699-705]", "[902]", "[904-906]", "[908]", "[910-929]",
                  "[931-974]", "[976-982]", "[986]", "[988]", "[990]", "[992]", "[994-999]"},
            FF_ESR = {"[256-305]", "[308-318]", "[321-328]",
                      "[330-382]", "[384-451]", "[461-496]", "[500-501]", "[506-535]", "[592-680]",
                      "[699-705]", "[902]", "[904-906]", "[908]", "[910-929]",
                      "[931-974]", "[976-982]", "[986]", "[988]", "[990]", "[992]", "[994-999]"})
    @HtmlUnitNYI(CHROME = {"[256-687]", "[880-883]", "[886-887]", "[891-893]", "[895]",
                           "[902]", "[904-906]", "[908]", "[910-929]", "[931-999]"},
            EDGE = {"[256-687]", "[880-883]", "[886-887]", "[891-893]", "[895]",
                    "[902]", "[904-906]", "[908]", "[910-929]", "[931-999]"},
            FF = {"[256-687]", "[880-883]", "[886-887]", "[891-893]", "[895]",
                  "[902]", "[904-906]", "[908]", "[910-929]", "[931-999]"},
            FF_ESR = {"[256-687]", "[880-883]", "[886-887]", "[891-893]", "[895]",
                      "[902]", "[904-906]", "[908]", "[910-929]", "[931-999]"})
    ...
    @Alerts(DEFAULT = {"[1000-1007]", "[1011]", "[1015-1016]", "[1018-1153]", "[1162-1327]", "[1329-1366]",
            ...
            FF_ESR = {"[1000-1011]", "[1025-1036]", "[1038-1103]", "[1105-1116]", "[1118-1153]", "[1168-1220]",
                      ...
                      "[1369]", "[1377-1414]", "[1488-1514]", "[1520-1522]", "[1569-1594]", "[1601-1610]",
                      "[1649-1719]", "[1722-1726]", "[1728-1742]", "[1744-1747]", "[1749]", "[1765-1766]"})
    @HtmlUnitNYI(CHROME = {"[1000-1013]", "[1015-1153]", "[1162-1327]", "[1329-1366]", "[1377-1415]",
            ...
            EDGE = {"[1000-1013]", "[1015-1153]", "[1162-1327]", "[1329-1366]", "[1377-1415]",
                    "[1488-1514]", "[1520-1522]", "[1568-1599]", "[1601-1610]", "[1646-1647]",
                    "[1649-1747]", "[1749]", "[1774-1775]", "[1786-1788]", "[1791]", "[1808]",
                    "[1810-1839]", "[1869-1957]", "[1969]", "[1994-1999]"},
            FF = {"[1000-1013]", "[1015-1153]", "[1162-1327]", "[1329-1366]", "[1377-1415]",
                  "[1488-1514]", "[1520-1522]", "[1568-1599]", "[1601-1610]", "[1646-1647]",
                  "[1649-1747]", "[1749]", "[1774-1775]", "[1786-1788]", "[1791]", "[1808]",
                  "[1810-1839]", "[1869-1957]", "[1969]", "[1994-1999]"},
            FF_ESR = {"[1000-1013]", "[1015-1153]", "[1162-1327]", "[1329-1366]", "[1377-1415]",
                      "[1488-1514]", "[1520-1522]", "[1568-1599]", "[1601-1610]", "[1646-1647]",
                      "[1649-1747]", "[1749]", "[1774-1775]", "[1786-1788]", "[1791]", "[1808]",
                      "[1810-1839]", "[1869-1957]", "[1969]", "[1994-1999]"})
    ...
    @Alerts(DEFAULT = {"[2000-2026]", "[2048-2069]", "[2112-2136]", "[2144-2154]", "[2160-2183]",
            ...
            FF_ESR = {"[2309-2361]", "[2365]", "[2392-2401]", "[2437-2444]", "[2447-2448]", "[2451-2472]",
                      ...
                      "[2908-2909]", "[2911-2913]", "[2949-2954]", "[2958-2960]", "[2962-2965]", "[2969-2970]",
                      "[2972]", "[2974-2975]", "[2979-2980]", "[2984-2986]", "[2990-2997]", "[2999]"})
    @HtmlUnitNYI(CHROME = {"[2000-2026]", "[2048-2069]", "[2112-2136]", "[2144-2154]", "[2208-2228]", "[2230-2237]",
                           ...
                           "[2984-2986]", "[2990-2999]"},
            EDGE = {"[2000-2026]", "[2048-2069]", "[2112-2136]", "[2144-2154]", "[2208-2228]", "[2230-2237]",
                    "[2308-2361]", "[2365]", "[2384]", "[2392-2401]", "[2418-2432]", "[2437-2444]",
                    "[2447-2448]", "[2451-2472]", "[2474-2480]", "[2482]", "[2486-2489]", "[2493]", "[2510]",
                    "[2524-2525]", "[2527-2529]", "[2544-2545]", "[2556]", "[2565-2570]", "[2575-2576]",
                    "[2579-2600]", "[2602-2608]", "[2610-2611]", "[2613-2614]", "[2616-2617]", "[2649-2652]",
                    ...
                    "[2962-2965]", "[2969-2970]", "[2972]", "[2974-2975]", "[2979-2980]",
                    "[2984-2986]", "[2990-2999]"},
            FF = {"[2000-2026]", "[2048-2069]", "[2112-2136]", "[2144-2154]", "[2208-2228]", "[2230-2237]",
                  "[2308-2361]", "[2365]", "[2384]", "[2392-2401]", "[2418-2432]", "[2437-2444]",
                  "[2447-2448]", "[2451-2472]", "[2474-2480]", "[2482]", "[2486-2489]", "[2493]", "[2510]",
                  "[2524-2525]", "[2527-2529]", "[2544-2545]", "[2556]", "[2565-2570]", "[2575-2576]",
                  "[2579-2600]", "[2602-2608]", "[2610-2611]", "[2613-2614]", "[2616-2617]", "[2649-2652]",
                  ...
                  "[2962-2965]", "[2969-2970]", "[2972]", "[2974-2975]", "[2979-2980]",
                  "[2984-2986]", "[2990-2999]"},
            FF_ESR = {"[2000-2026]", "[2048-2069]", "[2112-2136]", "[2144-2154]", "[2208-2228]", "[2230-2237]",
                      "[2308-2361]", "[2365]", "[2384]", "[2392-2401]", "[2418-2432]", "[2437-2444]",
                      "[2447-2448]", "[2451-2472]", "[2474-2480]", "[2482]", "[2486-2489]", "[2493]", "[2510]",
                      "[2524-2525]", "[2527-2529]", "[2544-2545]", "[2556]", "[2565-2570]", "[2575-2576]",
                      "[2579-2600]", "[2602-2608]", "[2610-2611]", "[2613-2614]", "[2616-2617]", "[2649-2652]",
    ...
    @Alerts(DEFAULT = {"[3000-3001]", "[3024]", "[3077-3084]", "[3086-3088]", "[3090-3112]", "[3114-3129]",
            ...
            FF_ESR = {"[3000-3001]", "[3077-3084]", "[3086-3088]", "[3090-3112]", "[3114-3123]", "[3125-3129]",
                      ...
                      "[3749]", "[3751]", "[3754-3755]", "[3757-3758]", "[3760]", "[3762-3763]", "[3773]",
                      "[3776-3780]", "[3904-3911]", "[3913-3945]"})
    @HtmlUnitNYI(CHROME = {"[3000-3001]", "[3024]", "[3077-3084]", "[3086-3088]", "[3090-3112]", "[3114-3129]",
                           "[3133]", "[3160-3162]", "[3168-3169]", "[3200]", "[3205-3212]", "[3214-3216]",
                           "[3218-3240]", "[3242-3251]", "[3253-3257]", "[3261]", "[3294]", "[3296-3297]",
                           "[3313-3314]", "[3333-3340]", "[3342-3344]", "[3346-3386]", "[3389]", "[3406]",
                           "[3412-3414]", "[3423-3425]", "[3450-3455]", "[3461-3478]", "[3482-3505]",
                           "[3507-3515]", "[3517]", "[3520-3526]", "[3585-3632]", "[3634-3635]", "[3648-3653]",
                           "[3713-3714]", "[3716]", "[3719-3720]", "[3722]", "[3725]", "[3732-3735]",
                           "[3737-3743]", "[3745-3747]", "[3749]", "[3751]", "[3754-3755]", "[3757-3760]",
                           "[3762-3763]", "[3773]", "[3776-3780]", "[3804-3807]", "[3840]", "[3904-3911]",
                           "[3913-3948]", "[3976-3980]"},
            EDGE = {"[3000-3001]", "[3024]", "[3077-3084]", "[3086-3088]", "[3090-3112]", "[3114-3129]",
                    "[3133]", "[3160-3162]", "[3168-3169]", "[3200]", "[3205-3212]", "[3214-3216]",
                    "[3218-3240]", "[3242-3251]", "[3253-3257]", "[3261]", "[3294]", "[3296-3297]",
                    "[3313-3314]", "[3333-3340]", "[3342-3344]", "[3346-3386]", "[3389]", "[3406]",
                    "[3412-3414]", "[3423-3425]", "[3450-3455]", "[3461-3478]", "[3482-3505]",
                    ...
                    "[3762-3763]", "[3773]", "[3776-3780]", "[3804-3807]", "[3840]", "[3904-3911]",
                    "[3913-3948]", "[3976-3980]"},
            FF = {"[3000-3001]", "[3024]", "[3077-3084]", "[3086-3088]", "[3090-3112]", "[3114-3129]",
                  "[3133]", "[3160-3162]", "[3168-3169]", "[3200]", "[3205-3212]", "[3214-3216]",
                  "[3218-3240]", "[3242-3251]", "[3253-3257]", "[3261]", "[3294]", "[3296-3297]",
                  "[3313-3314]", "[3333-3340]", "[3342-3344]", "[3346-3386]", "[3389]", "[3406]",
                  "[3412-3414]", "[3423-3425]", "[3450-3455]", "[3461-3478]", "[3482-3505]",
                  ...
                  "[3762-3763]", "[3773]", "[3776-3780]", "[3804-3807]", "[3840]", "[3904-3911]",
                  "[3913-3948]", "[3976-3980]"},
            FF_ESR = {"[3000-3001]", "[3024]", "[3077-3084]", "[3086-3088]", "[3090-3112]", "[3114-3129]",
                      "[3133]", "[3160-3162]", "[3168-3169]", "[3200]", "[3205-3212]", "[3214-3216]",
                      "[3218-3240]", "[3242-3251]", "[3253-3257]", "[3261]", "[3294]", "[3296-3297]",
                      "[3313-3314]", "[3333-3340]", "[3342-3344]", "[3346-3386]", "[3389]", "[3406]",
                      "[3412-3414]", "[3423-3425]", "[3450-3455]", "[3461-3478]", "[3482-3505]",
