...
public class GWTTest2x11x0 extends GWTTest {
    ...
    public void mail() throws Exception {
        ...
        final WebDriver driver = loadGWTPage(url, "//div[@class='Mb-c']");

        final WebElement cell = driver.findElement(By.xpath("//div[@class='Mb-c']"));
        assertTrue(cell.getText(), cell.getText().startsWith("Welcome back, foo@example.com"));

        final List<WebElement> cells = driver.findElements(By.xpath("//tr[@class='Md-a']/td"));
    ...
    private static void verifyStartMailBody(final WebDriver driver, final String... details) {
        final WebElement mail = driver.findElement(By.xpath("//div[@class='Mf-a']"));
