...
public class ElementPropertiesTest extends WebDriverTestCase {
    ...
    @Alerts(CHROME = "activeElement,adoptedStyleSheets,adoptNode(),alinkColor,all,anchors,append(),applets,bgColor,"
                ...
                + "referrer,releaseEvents(),replaceChildren(),rootElement,scripts,scrollingElement,"
                + "startViewTransition(),styleSheets,timeline,title,URL,visibilityState,vlinkColor,wasDiscarded,"
            ...
            EDGE = "activeElement,adoptedStyleSheets,adoptNode(),alinkColor,all,anchors,append(),applets,bgColor,"
                ...
                + "scrollingElement,startViewTransition(),styleSheets,timeline,title,URL,visibilityState,vlinkColor,"
    ...
    @HtmlUnitNYI(CHROME = "cloneContents(),cloneRange(),collapse(),commonAncestorContainer,"
                + "compareBoundaryPoints(),createContextualFragment(),deleteContents(),detach(),END_TO_END,"
                + "END_TO_START,extractContents(),getBoundingClientRect(),getClientRects(),"
                + "insertNode(),selectNode(),selectNodeContents(),setEnd(),setEndAfter(),setEndBefore(),setStart(),"
                + "setStartAfter(),setStartBefore(),START_TO_END,START_TO_START,"
                + "surroundContents(),toString()",
            EDGE = "cloneContents(),cloneRange(),collapse(),commonAncestorContainer,"
                + "compareBoundaryPoints(),createContextualFragment(),deleteContents(),detach(),END_TO_END,"
                + "END_TO_START,extractContents(),getBoundingClientRect(),getClientRects(),"
                + "insertNode(),selectNode(),selectNodeContents(),setEnd(),setEndAfter(),setEndBefore(),setStart(),"
                + "setStartAfter(),setStartBefore(),START_TO_END,START_TO_START,"
                + "surroundContents(),toString()",
            FF_ESR = "cloneContents(),cloneRange(),collapse(),commonAncestorContainer,"
                + "compareBoundaryPoints(),"
                + "createContextualFragment(),deleteContents(),detach(),END_TO_END,END_TO_START,"
                + "extractContents(),getBoundingClientRect(),getClientRects(),insertNode(),selectNode(),"
                + "selectNodeContents(),setEnd(),setEndAfter(),setEndBefore(),setStart(),setStartAfter(),"
                + "setStartBefore(),START_TO_END,START_TO_START,surroundContents(),"
                + "toString()",
