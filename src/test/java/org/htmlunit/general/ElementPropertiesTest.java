...
public class ElementPropertiesTest extends WebDriverTestCase {
    ...
    @Alerts(CHROME = "addEventListener(),alert(),atob(),blur(),btoa(),caches,cancelAnimationFrame(),"
                ...
                + "onoffline,ononline,onpagehide,onpagereveal,onpageshow,onpause,onplay,onplaying,onpointercancel,"
    ...
    @Alerts(CHROME = "adAuctionHeaders,align,allow,allowFullscreen,allowPaymentRequest,contentDocument,contentWindow,"
                ...
                + "marginHeight,marginWidth,name,privateToken,referrerPolicy,sandbox,scrolling,src,srcdoc,"
                + "width",
     ...
     */
    @Test
    @Alerts(CHROME = "content,shadowRootDelegatesFocus,shadowRootMode",
            EDGE = "content,shadowRootDelegatesFocus,shadowRootMode",
    ...
    @Alerts(CHROME = "0,1,10,100,101,102,103,104,105,106,107,108,109,11,110,111,112,113,114,115,116,117,118,119,12,120,"
            ...
            FF = "-moz-animation,-moz-animation-delay,-moz-animation-direction,-moz-animation-duration,"
                ...
                + "objectPosition,offset,offset-anchor,offset-distance,offset-path,offset-position,offset-rotate,"
                + "offsetAnchor,offsetDistance,offsetPath,offsetPosition,offsetRotate,opacity,order,outline,"
