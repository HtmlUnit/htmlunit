...
public class ElementPropertiesTest extends WebDriverTestCase {
    ...
    @Alerts(CHROME = "0,1,10,100,101,102,103,104,105,106,107,108,109,11,110,111,112,113,114,115,116,117,118,119,12,120,"
                ...
                + "393,394,395,396,397,398,399,4,40,400,401,41,42,43,44,45,46,47,48,49,5,50,51,52,53,54,55,56,57,58,"
                ...
                + "breakInside,bufferedRendering,captionSide,caretColor,clear,clip,clipPath,clipRule,color,"
                ...
                + "system,tableLayout,tabSize,textAlign,textAlignLast,textAnchor,textBox,textBoxEdge,textBoxTrim,"
