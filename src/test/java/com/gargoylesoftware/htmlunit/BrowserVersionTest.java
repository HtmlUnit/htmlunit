...
public class BrowserVersionTest {
    ...
    public void getBrowserVersionNumeric() {
        assertEquals(99, BrowserVersion.FIREFOX.getBrowserVersionNumeric());
        ...
        assertEquals(100, BrowserVersion.CHROME.getBrowserVersionNumeric());
        assertEquals(100, BrowserVersion.EDGE.getBrowserVersionNumeric());
    }
