...
public class CSSStyleSheet2Test extends SimpleWebTestCase {
    ...
    public void selects_miscSelectors() throws Exception {
        ...
        final HTMLStyleElement host = (HTMLStyleElement) node.getScriptObject2();
    ...
    public void brokenExternalCSS() throws Exception {
        ...
        final ComputedCSSStyleDeclaration style = ((HTMLElement) element.getScriptObject2()).getCurrentStyle();
