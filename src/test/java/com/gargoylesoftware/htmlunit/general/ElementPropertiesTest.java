...
public class ElementPropertiesTest extends WebDriverTestCase {
    ...
    @Alerts(CHROME = "accentColor,additiveSymbols,alignContent,alignItems,alignmentBaseline,alignSelf,all,animation,"
            ...
            IE = "accelerator,alignContent,alignItems,alignmentBaseline,alignSelf,animation,animationDelay,"
                ...
                + "zoom")
    @HtmlUnitNYI(IE = "accelerator,alignContent,alignItems,alignmentBaseline,alignSelf,animation,animationDelay,"
                + "animationDirection,animationDuration,animationFillMode,animationIterationCount,animationName,"
                + "animationPlayState,animationTimingFunction,backfaceVisibility,background,backgroundAttachment,"
                + "backgroundClip,backgroundColor,backgroundImage,backgroundOrigin,backgroundPosition,"
                ...
                + "borderImageRepeat,borderImageSlice,borderImageSource,borderImageWidth,borderLeft,"
                + "borderLeftColor,borderLeftStyle,borderLeftWidth,borderRadius,borderRight,borderRightColor,"
                + "borderRightStyle,borderRightWidth,borderSpacing,borderStyle,borderTop,borderTopColor,"
                + "borderTopLeftRadius,borderTopRightRadius,borderTopStyle,borderTopWidth,borderWidth,bottom,"
                + "boxShadow,boxSizing,breakAfter,breakBefore,breakInside,captionSide,clear,clip,clipPath,"
                + "clipRule,color,colorInterpolationFilters,columnCount,columnFill,columnGap,columnRule,"
                + "columnRuleColor,columnRuleStyle,columnRuleWidth,columns,columnSpan,columnWidth,content,"
                + "counterIncrement,counterReset,cssFloat,cssText,cursor,direction,display,dominantBaseline,"
                + "emptyCells,enableBackground,fill,fillOpacity,fillRule,filter,flex,flexBasis,flexDirection,"
                + "flexFlow,flexGrow,flexShrink,flexWrap,floodColor,floodOpacity,font,fontFamily,"
                + "fontFeatureSettings,fontSize,fontSizeAdjust,fontStretch,fontStyle,fontVariant,fontWeight,"
                + "getAttribute(),getPropertyPriority(),getPropertyValue(),glyphOrientationHorizontal,"
                + "glyphOrientationVertical,height,imeMode,item(),justifyContent,kerning,layoutFlow,"
                + "layoutGrid,layoutGridChar,layoutGridLine,layoutGridMode,layoutGridType,left,length,"
                + "letterSpacing,lightingColor,lineBreak,lineHeight,listStyle,listStyleImage,listStylePosition,"
                + "listStyleType,margin,marginBottom,marginLeft,marginRight,marginTop,marker,markerEnd,"
                + "markerMid,markerStart,mask,maxHeight,maxWidth,minHeight,minWidth,msAnimation,"
                + "msAnimationDelay,msAnimationDirection,msAnimationDuration,msAnimationFillMode,"
                + "msAnimationIterationCount,msAnimationName,msAnimationPlayState,msAnimationTimingFunction,"
                + "msBackfaceVisibility,msBlockProgression,msContentZoomChaining,msContentZooming,"
                + "msContentZoomLimit,msContentZoomLimitMax,msContentZoomLimitMin,msContentZoomSnap,"
                + "msContentZoomSnapPoints,msContentZoomSnapType,msFlex,msFlexAlign,msFlexDirection,"
                + "msFlexFlow,msFlexItemAlign,msFlexLinePack,msFlexNegative,msFlexOrder,msFlexPack,"
                + "msFlexPositive,msFlexPreferredSize,msFlexWrap,msFlowFrom,msFlowInto,msFontFeatureSettings,"
                + "msGridColumn,msGridColumnAlign,msGridColumns,msGridColumnSpan,msGridRow,msGridRowAlign,"
                + "msGridRows,msGridRowSpan,msHighContrastAdjust,msHyphenateLimitChars,msHyphenateLimitLines,"
                + "msHyphenateLimitZone,msHyphens,msImeAlign,msInterpolationMode,msOverflowStyle,"
                + "msPerspective,msPerspectiveOrigin,msScrollChaining,msScrollLimit,msScrollLimitXMax,"
                + "msScrollLimitXMin,msScrollLimitYMax,msScrollLimitYMin,msScrollRails,msScrollSnapPointsX,"
                + "msScrollSnapPointsY,msScrollSnapType,msScrollSnapX,msScrollSnapY,msScrollTranslation,"
                + "msTextCombineHorizontal,msTextSizeAdjust,msTouchAction,msTouchSelect,msTransform,"
                + "msTransformOrigin,msTransformStyle,msTransition,msTransitionDelay,msTransitionDuration,"
                + "msTransitionProperty,msTransitionTimingFunction,msUserSelect,msWrapFlow,msWrapMargin,"
                + "msWrapThrough,opacity,order,orphans,outline,outlineColor,outlineStyle,outlineWidth,"
                + "overflow,overflowX,overflowY,padding,paddingBottom,paddingLeft,paddingRight,paddingTop,"
                + "pageBreakAfter,pageBreakBefore,pageBreakInside,parentRule,perspective,perspectiveOrigin,"
                + "pixelBottom,pixelHeight,pixelLeft,pixelRight,pixelTop,pixelWidth,pointerEvents,posBottom,"
                + "posHeight,position,posLeft,posRight,posTop,posWidth,quotes,removeAttribute(),removeProperty(),"
                ...
                + "stroke,strokeDasharray,strokeDashoffset,strokeLinecap,strokeLinejoin,strokeMiterlimit,"
                + "strokeOpacity,strokeWidth,styleFloat,tableLayout,textAlign,textAlignLast,textAnchor,"
                + "textAutospace,textDecoration,textDecorationBlink,textDecorationLineThrough,"
                + "textDecorationNone,textDecorationOverline,textDecorationUnderline,textIndent,textJustify,"
                + "textJustifyTrim,textKashida,textKashidaSpace,textOverflow,textShadow,textTransform,"
                + "textUnderlinePosition,top,touchAction,transform,transformOrigin,transformStyle,transition,"
                + "transitionDelay,transitionDuration,transitionProperty,transitionTimingFunction,unicodeBidi,"
                + "verticalAlign,visibility,whiteSpace,widows,width,wordBreak,wordSpacing,wordWrap,"
