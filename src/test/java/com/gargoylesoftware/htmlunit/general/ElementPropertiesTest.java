...
public class ElementPropertiesTest extends WebDriverTestCase {
    ...
    @Alerts(CHROME = "accessKey,attachInternals(),autocapitalize,"
            ...
            FF68 = "accessKey,accessKeyLabel,blur(),click(),contentEditable,contextMenu,dataset,dir,draggable,focus(),hidden,"
                ...
                + "oncanplaythrough,onchange,onclick,onclose,oncontextmenu,oncopy,oncuechange,oncut,ondblclick,ondrag,ondragend,"
                + "ondragenter,ondragexit,ondragleave,ondragover,ondragstart,ondrop,ondurationchange,onemptied,onended,onerror,"
                + "onfocus,ongotpointercapture,oninput,oninvalid,onkeydown,onkeypress,onkeyup,onload,onloadeddata,onloadedmetadata,"
                + "onloadend,onloadstart,onlostpointercapture,onmousedown,onmouseenter,onmouseleave,onmousemove,onmouseout,"
                + "onmouseover,onmouseup,onmozfullscreenchange,onmozfullscreenerror,onpaste,onpause,onplay,onplaying,"
                + "onpointercancel,onpointerdown,onpointerenter,onpointerleave,onpointermove,onpointerout,onpointerover,"
                + "onpointerup,onprogress,onratechange,onreset,onresize,onscroll,onseeked,onseeking,onselect,onselectstart,"
                + "onshow,onstalled,onsubmit,onsuspend,ontimeupdate,ontoggle,ontransitioncancel,ontransitionend,ontransitionrun,"
    ...
    @Alerts(CHROME = "animate(),append(),attachShadow(),attributes,attributeStyleMap,"
            ...
            FF68 = "animate(),append(),attachShadow(),attributes,childElementCount,children,classList,className,"
                ...
                + "getAttributeNames(),getAttributeNode(),getAttributeNodeNS(),getAttributeNS(),getBoundingClientRect(),"
                + "getClientRects(),getElementsByClassName(),getElementsByTagName(),getElementsByTagNameNS(),"
                + "hasAttribute(),hasAttributeNS(),hasAttributes(),hasPointerCapture(),id,innerHTML,insertAdjacentElement(),"
                + "insertAdjacentHTML(),insertAdjacentText(),lastElementChild,localName,matches(),mozMatchesSelector(),"
                + "mozRequestFullScreen(),namespaceURI,onfullscreenchange,onfullscreenerror,outerHTML,prefix,prepend(),"
                + "querySelector(),querySelectorAll(),releaseCapture(),releasePointerCapture(),removeAttribute(),"
                + "removeAttributeNode(),removeAttributeNS(),requestFullscreen(),requestPointerLock(),scroll(),scrollBy(),"
                + "scrollHeight,scrollIntoView(),scrollLeft,scrollLeftMax,scrollTo(),scrollTop,scrollTopMax,scrollWidth,"
                + "setAttribute(),setAttributeNode(),setAttributeNodeNS(),setAttributeNS(),setCapture(),setPointerCapture(),"
    ...
    @Alerts(CHROME = "after(),animate(),assignedSlot,attachShadow(),attributes,attributeStyleMap,"
            ...
            FF68 = "after(),animate(),assignedSlot,attachShadow(),attributes,before(),classList,className,clientHeight,"
                ...
                + "hasPointerCapture(),id,innerHTML,insertAdjacentElement(),insertAdjacentHTML(),insertAdjacentText(),"
                + "localName,matches(),mozMatchesSelector(),mozRequestFullScreen(),namespaceURI,nextElementSibling,"
                + "onfullscreenchange,onfullscreenerror,outerHTML,prefix,previousElementSibling,releaseCapture(),"
                + "releasePointerCapture(),remove(),removeAttribute(),removeAttributeNode(),removeAttributeNS(),"
                + "replaceWith(),requestFullscreen(),requestPointerLock(),scroll(),scrollBy(),scrollHeight,scrollIntoView(),"
                + "scrollLeft,scrollLeftMax,scrollTo(),scrollTop,scrollTopMax,scrollWidth,setAttribute(),setAttributeNode(),"
    ...
    @Alerts(CHROME = "addEventListener(),alert(),applicationCache,atob(),blur(),btoa(),caches,cancelAnimationFrame(),"
            ...
            FF68 = "addEventListener(),alert(),applicationCache,atob(),blur(),btoa(),caches,cancelAnimationFrame(),"
                ...
                + "onseeked,onseeking,onselect,onselectstart,onshow,onstalled,onstorage,onsubmit,onsuspend,ontimeupdate,"
                + "ontoggle,ontransitioncancel,ontransitionend,ontransitionrun,ontransitionstart,onunload,onuserproximity,"
                + "onvolumechange,onvrdisplayactivate,onvrdisplayconnect,onvrdisplaydeactivate,onvrdisplaydisconnect,"
                + "onvrdisplaypresentchange,onwaiting,onwebkitanimationend,onwebkitanimationiteration,onwebkitanimationstart,"
                + "onwebkittransitionend,onwheel,open(),opener,origin,outerHeight,outerWidth,pageXOffset,pageYOffset,"
                + "parent,performance,personalbar,postMessage(),print(),process(),prompt(),releaseEvents(),"
                + "removeEventListener(),requestAnimationFrame(),requestIdleCallback(),resizeBy(),resizeTo(),screen,"
                + "screenLeft,screenTop,screenX,screenY,scroll(),scrollbars,scrollBy(),scrollByLines(),scrollByPages(),"
                + "scrollMaxX,scrollMaxY,scrollTo(),scrollX,scrollY,self,sessionStorage,setInterval(),setResizable(),"
                + "setTimeout(),sidebar,sizeToContent(),sortFunction(),speechSynthesis,status,statusbar,stop(),test(),"
                + "toolbar,top,u2f,updateCommands(),window",
    ...
    @Alerts(CHROME = "addTextTrack(),autoplay,buffered,"
            ...
            FF68 = "addTextTrack(),autoplay,buffered,canPlayType(),controls,crossOrigin,currentSrc,currentTime,"
                ...
                + "HAVE_FUTURE_DATA,HAVE_METADATA,HAVE_NOTHING,load(),loop,mediaKeys,mozAudioCaptured,mozCaptureStream(),"
                + "mozCaptureStreamUntilEnded(),mozFragmentEnd,mozGetMetadata(),mozPreservesPitch,muted,NETWORK_EMPTY,"
                + "NETWORK_IDLE,NETWORK_LOADING,NETWORK_NO_SOURCE,networkState,onencrypted,onwaitingforkey,pause(),"
                + "paused,play(),playbackRate,played,preload,readyState,seekable,seeking,seekToNextFrame(),"
                + "setMediaKeys(),src,srcObject,textTracks,volume",
    ...
    @Alerts(CHROME = "activeElement,adoptedStyleSheets,adoptNode(),alinkColor,all,anchors,append(),applets,"
            ...
            FF68 = "activeElement,adoptNode(),anchors,append(),applets,async,body,caretPositionFromPoint(),"
                ...
                + "ontransitioncancel,ontransitionend,ontransitionrun,ontransitionstart,onvisibilitychange,onvolumechange,"
                + "onwaiting,onwebkitanimationend,onwebkitanimationiteration,onwebkitanimationstart,onwebkittransitionend,"
                + "onwheel,plugins,pointerLockElement,preferredStyleSheetSet,prepend(),querySelector(),querySelectorAll(),"
                + "readyState,referrer,releaseCapture(),requestStorageAccess(),rootElement,scripts,scrollingElement,"
    ...
    @Alerts(CHROME = "appendChild(),ATTRIBUTE_NODE,baseURI,CDATA_SECTION_NODE,childNodes,cloneNode(),COMMENT_NODE,"
            ...
            FF68 = "appendChild(),ATTRIBUTE_NODE,baseURI,CDATA_SECTION_NODE,childNodes,cloneNode(),COMMENT_NODE,"
                + "compareDocumentPosition(),contains(),DOCUMENT_FRAGMENT_NODE,DOCUMENT_NODE,DOCUMENT_POSITION_CONTAINED_BY,"
                ...
                + "ENTITY_NODE,ENTITY_REFERENCE_NODE,firstChild,getRootNode(),hasChildNodes(),insertBefore(),isConnected,"
                + "isDefaultNamespace(),isEqualNode(),isSameNode(),lastChild,localName,lookupNamespaceURI(),lookupPrefix(),"
                + "name,namespaceURI,nextSibling,nodeName,nodeType,nodeValue,normalize(),NOTATION_NODE,ownerDocument,"
                + "ownerElement,parentElement,parentNode,prefix,previousSibling,PROCESSING_INSTRUCTION_NODE,removeChild(),"
