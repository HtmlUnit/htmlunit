...
public class ElementPropertiesTest extends WebDriverTestCase {
    ...
    @Alerts(CHROME = "accessKey,attachInternals(),autocapitalize,autofocus,blur(),click(),contentEditable,dataset,dir,"
                + "draggable,enterKeyHint,focus(),hidden,inert,innerText,inputMode,isContentEditable,lang,nonce,"
                + "offsetHeight,offsetLeft,offsetParent,offsetTop,offsetWidth,onabort,onanimationend,"
                + "onanimationiteration,onanimationstart,onauxclick,onbeforematch,onbeforexrselect,onblur,oncancel,"
     ...
     */
    @Test
    @Alerts(CHROME = "animate(),append(),ariaAtomic,ariaAutoComplete,ariaBusy,ariaChecked,ariaColCount,ariaColIndex,"
                ...
                + "attributes,attributeStyleMap,childElementCount,children,classList,className,clientHeight,"
                ...
                + "replaceChildren(),requestFullscreen(),requestPointerLock(),role,"
            ...
            EDGE = "animate(),append(),ariaAtomic,ariaAutoComplete,ariaBusy,ariaChecked,ariaColCount,ariaColIndex,"
                + "ariaColSpan,ariaCurrent,ariaDescription,ariaDisabled,ariaExpanded,ariaHasPopup,ariaHidden,"
                + "ariaInvalid,ariaKeyShortcuts,ariaLabel,ariaLevel,ariaLive,ariaModal,ariaMultiLine,"
                + "ariaMultiSelectable,ariaOrientation,ariaPlaceholder,ariaPosInSet,ariaPressed,ariaReadOnly,"
                + "ariaRelevant,ariaRequired,ariaRoleDescription,ariaRowCount,ariaRowIndex,ariaRowSpan,ariaSelected,"
     ...
     */
    @Test
    @Alerts(CHROME = "after(),animate(),ariaAtomic,ariaAutoComplete,ariaBusy,ariaChecked,ariaColCount,ariaColIndex,"
                + "ariaColSpan,ariaCurrent,ariaDescription,ariaDisabled,ariaExpanded,ariaHasPopup,ariaHidden,"
                + "ariaInvalid,ariaKeyShortcuts,ariaLabel,ariaLevel,ariaLive,ariaModal,ariaMultiLine,"
                + "ariaMultiSelectable,ariaOrientation,ariaPlaceholder,ariaPosInSet,ariaPressed,ariaReadOnly,"
                + "ariaRelevant,ariaRequired,ariaRoleDescription,ariaRowCount,ariaRowIndex,ariaRowSpan,ariaSelected,"
                + "ariaSetSize,ariaSort,ariaValueMax,ariaValueMin,ariaValueNow,ariaValueText,assignedSlot,"
                + "attachShadow(),attributes,attributeStyleMap,before(),classList,className,clientHeight,clientLeft,"
                ...
                + "requestFullscreen(),requestPointerLock(),role,"
                + "scroll(),scrollBy(),scrollHeight,scrollIntoView(),"
                + "scrollIntoViewIfNeeded(),scrollLeft,scrollTo(),scrollTop,scrollWidth,setAttribute(),"
                + "setAttributeNode(),setAttributeNodeNS(),setAttributeNS(),setPointerCapture(),shadowRoot,slot,"
                + "tagName,toggleAttribute(),webkitMatchesSelector(),webkitRequestFullScreen(),"
                + "webkitRequestFullscreen()",
            EDGE = "after(),animate(),ariaAtomic,ariaAutoComplete,ariaBusy,ariaChecked,ariaColCount,ariaColIndex,"
                + "ariaColSpan,ariaCurrent,ariaDescription,ariaDisabled,ariaExpanded,ariaHasPopup,ariaHidden,"
                + "ariaInvalid,ariaKeyShortcuts,ariaLabel,ariaLevel,ariaLive,ariaModal,ariaMultiLine,"
                + "ariaMultiSelectable,ariaOrientation,ariaPlaceholder,ariaPosInSet,ariaPressed,ariaReadOnly,"
                + "ariaRelevant,ariaRequired,ariaRoleDescription,ariaRowCount,ariaRowIndex,ariaRowSpan,ariaSelected,"
    ...
    @Alerts(CHROME = "addEventListener(),alert(),atob(),blur(),btoa(),caches,cancelAnimationFrame(),"
                ...
                + "onanimationstart,onappinstalled,onauxclick,onbeforeinstallprompt,onbeforematch,onbeforeprint,"
                + "onbeforeunload,onbeforexrselect,onblur,oncancel,oncanplay,oncanplaythrough,onchange,onclick,"
                + "onclose,oncontextlost,oncontextmenu,oncontextrestored,oncuechange,ondblclick,ondevicemotion,"
     ...
     */
    @Test
    @Alerts(CHROME = "as,charset,crossOrigin,disabled,fetchPriority,href,hreflang,imageSizes,imageSrcset,integrity,"
                + "media,referrerPolicy,rel,relList,rev,sheet,sizes,target,"
                + "type",
            EDGE = "as,charset,crossOrigin,disabled,fetchPriority,href,hreflang,imageSizes,imageSrcset,integrity,"
                + "media,referrerPolicy,rel,relList,rev,sheet,sizes,target,"
                + "type",
    ...
    @Alerts(CHROME = "async,charset,crossOrigin,defer,event,fetchPriority,htmlFor,"
            ...
            EDGE = "async,charset,crossOrigin,defer,event,fetchPriority,htmlFor,integrity,noModule,referrerPolicy,src,"
                + "text,"
                + "type",
    ...
    @Alerts(CHROME = "activeElement,adoptedStyleSheets,adoptNode(),alinkColor,all,anchors,append(),applets,"
                + "bgColor,body,"
                + "captureEvents(),caretRangeFromPoint(),characterSet,charset,childElementCount,children,clear(),"
                + "close(),compatMode,contentType,cookie,createAttribute(),createAttributeNS(),createCDATASection(),"
                ...
                + "evaluate(),execCommand(),exitFullscreen(),exitPictureInPicture(),exitPointerLock(),featurePolicy,"
                + "fgColor,firstElementChild,fonts,forms,fragmentDirective,fullscreen,fullscreenElement,"
                ...
                + "xmlVersion",
            EDGE = "activeElement,adoptedStyleSheets,adoptNode(),alinkColor,all,anchors,append(),applets,bgColor,body,"
                + "captureEvents(),caretRangeFromPoint(),characterSet,charset,childElementCount,children,clear(),"
                + "close(),compatMode,contentType,cookie,createAttribute(),createAttributeNS(),createCDATASection(),"
                + "createComment(),createDocumentFragment(),createElement(),createElementNS(),createEvent(),"
                + "createExpression(),createNodeIterator(),createNSResolver(),createProcessingInstruction(),"
                ...
                + "linkColor,links,location,onabort,onanimationend,onanimationiteration,onanimationstart,onauxclick,"
                + "onbeforecopy,onbeforecut,onbeforematch,onbeforepaste,onbeforexrselect,onblur,oncancel,oncanplay,"
    ...
    @Alerts(CHROME = "autofocus,blur(),dataset,focus(),nonce,onabort,onanimationend,onanimationiteration,"
                + "onanimationstart,onauxclick,onbeforematch,onbeforexrselect,onblur,oncancel,oncanplay,"
                + "oncanplaythrough,onchange,onclick,onclose,oncontextlost,oncontextmenu,oncontextrestored,oncopy,"
                + "oncuechange,oncut,ondblclick,ondrag,ondragend,ondragenter,ondragleave,ondragover,ondragstart,"
