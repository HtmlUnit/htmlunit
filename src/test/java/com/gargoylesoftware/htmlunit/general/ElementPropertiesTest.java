...
public class ElementPropertiesTest extends WebDriverTestCase {
    ...
    @Alerts(CHROME = {"addEventListener(),alert(),atob(),blur(),btoa(),caches,cancelAnimationFrame(),"
                ...
                + "sortFunction(),speechSynthesis,status,statusbar,stop(),styleMedia,"
    ...
    @Alerts(CHROME = "detail,initUIEvent(),sourceCapabilities,view,which",
            ...
            FF78 = "detail,initUIEvent(),layerX,layerY,rangeOffset,rangeParent,"
                + "SCROLL_PAGE_DOWN,SCROLL_PAGE_UP,view,which",
    ...
    @HtmlUnitNYI(CHROME = "open(),write(),writeln()",
            ...
            FF78 = "close(),domain,open(),write(),writeln()",
            FF = "close(),domain,open(),write(),writeln()",
    ...
    @Alerts(CHROME = {"activeElement,adoptedStyleSheets,adoptNode(),alinkColor,all,anchors,append(),applets,"
                ...
                + "firstElementChild,fonts,forms,fragmentDirective,"
                + "fullscreen,fullscreenElement,fullscreenEnabled,getAnimations(),"
                ...
                + "releaseEvents(),replaceChildren(),rootElement,"
                + "scripts,scrollingElement,styleSheets,timeline,title,URL,"
            ...
            EDGE = {"activeElement,adoptedStyleSheets,adoptNode(),alinkColor,all,anchors,append(),applets,"
                ...
                + "onmouseout,onmouseover,onmouseup,onmousewheel,onpaste,onpause,onplay,onplaying",
                "onpointercancel,onpointerdown,onpointerenter,onpointerleave,"
                + "onpointerlockchange,onpointerlockerror,onpointermove,"
                ...
                + "prepend(),queryCommandEnabled(),queryCommandIndeterm(),queryCommandState(),queryCommandSupported(),"
                + "queryCommandValue(),querySelector(),querySelectorAll(),readyState,referrer,"
                + "releaseEvents(),replaceChildren(),requestStorageAccess(),rootElement,"
                + "scripts,scrollingElement,"
            ...
            FF78 = {"activeElement,adoptNode(),alinkColor,all,anchors,append(),applets,bgColor,"
                ...
                + "onvolumechange,onwaiting,onwebkitanimationend,onwebkitanimationiteration,onwebkitanimationstart,"
                + "onwebkittransitionend,onwheel,open(),plugins,pointerLockElement,preferredStyleSheetSet,prepend(),"
    ...
    @HtmlUnitNYI(CHROME = {"activeElement,adoptNode(),alinkColor,all,anchors,applets,bgColor,"
                + "body,captureEvents(),characterSet,charset,childElementCount,"
            ...
            EDGE = {"activeElement,adoptNode(),alinkColor,all,anchors,applets,bgColor,"
                ...
                + "scripts,styleSheets,"
                + "title,URL,vlinkColor,xmlEncoding,xmlStandalone,xmlVersion"},
            FF78 = "activeElement,adoptNode(),alinkColor,all,anchors,applets,bgColor,body,captureEvents(),characterSet,"
                + "charset,childElementCount,children,clear(),compatMode,contentType,cookie,"
                ...
                + "currentScript,defaultView,designMode,doctype,documentElement,documentURI,elementFromPoint(),"
                + "embeds,evaluate(),execCommand(),"
                + "fgColor,firstElementChild,fonts,forms,getElementById(),getElementsByClassName(),getElementsByName(),"
                ...
                + "onratechange,onreadystatechange,onreset,onresize,onscroll,onseeked,onseeking,onselect,"
                + "onshow,onstalled,onsubmit,onsuspend,ontimeupdate,onvolumechange,onwaiting,onwheel,plugins,"
                + "queryCommandEnabled(),queryCommandSupported(),querySelector(),querySelectorAll(),"
                + "readyState,referrer,releaseCapture(),releaseEvents(),rootElement,scripts,"
                + "styleSheets,title,URL,vlinkColor",
            FF = "activeElement,adoptNode(),alinkColor,all,anchors,applets,bgColor,body,captureEvents(),"
                + "characterSet,charset,childElementCount,children,clear(),compatMode,contentType,cookie,"
                + "createAttribute(),createCDATASection(),createComment(),createDocumentFragment(),"
                + "createElement(),createElementNS(),createEvent(),createNodeIterator(),createNSResolver(),"
                + "createProcessingInstruction(),createRange(),createTextNode(),createTreeWalker(),"
                + "currentScript,defaultView,designMode,doctype,documentElement,documentURI,elementFromPoint(),"
                ...
                + "readyState,referrer,releaseCapture(),releaseEvents(),rootElement,scripts,"
                + "styleSheets,title,URL,vlinkColor",
            IE = {"activeElement,adoptNode(),alinkColor,all,anchors,applets,"
                + "bgColor,body,captureEvents(),characterSet,"
                ...
                + "onreset,onscroll,onseeked,onseeking,onselect,onselectionchange,onselectstart",
                "onstalled,onstop,onstoragecommit,onsubmit,onsuspend,ontimeupdate,onvolumechange,onwaiting,"
                + "parentWindow,plugins,"
