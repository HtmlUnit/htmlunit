...
public class ElementPropertiesTest extends WebDriverTestCase {
    ...
    @Alerts(CHROME = "animate(),append(),ariaAtomic,ariaAutoComplete,ariaBusy,ariaChecked,ariaColCount,ariaColIndex,"
                ...
                + "attributes,attributeStyleMap,checkVisibility(),childElementCount,children,classList,className,"
                + "clientHeight,clientLeft,clientTop,clientWidth,closest(),computedStyleMap(),elementTiming,"
                ...
                + "getElementsByClassName(),getElementsByTagName(),getElementsByTagNameNS(),getInnerHTML(),"
    ...
    @Alerts(CHROME = "after(),animate(),ariaAtomic,ariaAutoComplete,ariaBusy,ariaChecked,ariaColCount,ariaColIndex,"
                ...
                + "attachShadow(),attributes,attributeStyleMap,before(),checkVisibility(),classList,className,"
                + "clientHeight,clientLeft,clientTop,clientWidth,closest(),computedStyleMap(),elementTiming,"
    ...
    @Alerts(CHROME = "autofocus,blur(),dataset,focus(),nonce,onabort,onanimationend,onanimationiteration,"
                + "onanimationstart,onauxclick,onbeforeinput,onbeforematch,onbeforexrselect,onblur,oncancel,"
    ...
    @Alerts(CHROME = "0,1,10,100,101,102,103,104,105,106,107,108,109,11,110,111,112,113,114,115,116,117,118,119,12,120,"
                ...
                + "imageRendering,inherits,initialValue,inlineSize,inset,insetBlock,insetBlockEnd,insetBlockStart,"
                + "insetInline,insetInlineEnd,insetInlineStart,isolation,item(),justifyContent,justifyItems,"
                ...
                + "marginRight,marginTop,marker,markerEnd,markerMid,markerStart,mask,maskType,maxBlockSize,"
                + "maxHeight,maxInlineSize,maxWidth,maxZoom,minBlockSize,minHeight,minInlineSize,minWidth,minZoom,"
                + "mixBlendMode,negative,objectFit,objectPosition,objectViewBox,offset,offsetDistance,offsetPath,"
                + "offsetRotate,opacity,order,orientation,orphans,outline,outlineColor,outlineOffset,outlineStyle,"
