...
//            + LOG_TITLE_FUNCTION
//            + "  function test() {\n"
//            + "    if(typeof " + className + " !== 'function') {log('unknown');return;}\n"
//
//            + "    var res = '';\n"
//            + "    try {\n"
//            + "      var ctor = typeof " + className + ".constructor === 'function';\n"
//            + "      res += ctor;\n"
//            + "      if (ctor) { new " + className + "(); res += '-called'; }\n"
...
//        loadPageVerifyTitle2(html);
     ...
     */
    @Test
    @Alerts(CHROME = "true-exception",
            EDGE = "true-exception",
            FF = "true-exception",
            FF_ESR = "true-exception",
            IE = "unknown")
