...
public class ElementOwnPropertiesTest extends WebDriverTestCase {
    ...
    @Alerts(CHROME = "accessKey,attachInternals(),autocapitalize,autofocus,blur(),click(),"
            ...
            FF = "accessKey,accessKeyLabel,attachInternals(),blur(),click(),constructor(),contentEditable,dataset,"
                ...
                + "title",
            FF78 = "accessKey,accessKeyLabel,blur(),click(),constructor(),contentEditable,dataset,dir,draggable,"
    ...
    @Alerts(CHROME = "cols,constructor(),onafterprint,onbeforeprint,onbeforeunload,onblur,onerror,onfocus,onhashchange,"
            ...
            FF = "cols,constructor(),onafterprint,onbeforeprint,onbeforeunload,"
                ...
                + "rows",
            FF78 = "cols,constructor(),onafterprint,onbeforeprint,onbeforeunload,ongamepadconnected,"
    ...
    @Alerts(CHROME = "align,allow,allowFullscreen,allowPaymentRequest,constructor(),contentDocument,contentWindow,"
            ...
            FF = "align,allow,allowFullscreen,constructor(),contentDocument,contentWindow,"
                ...
                + "width",
            FF78 = "align,allow,allowFullscreen,constructor(),contentDocument,contentWindow,frameBorder,"
    ...
    @Alerts(CHROME = "altitudeAngle,azimuthAngle,constructor(),getCoalescedEvents(),getPredictedEvents(),height,"
            ...
            FF = "constructor(),getCoalescedEvents(),getPredictedEvents(),"
                ...
                + "tangentialPressure,tiltX,tiltY,twist,width",
            FF78 = "constructor(),getCoalescedEvents(),getPredictedEvents(),height,isPrimary,pointerId,pointerType,"
                + "pressure,tangentialPressure,tiltX,tiltY,twist,"
                + "width",
            IE = "exception")
    ...
    @Alerts(CHROME = "constructor(),data,dataTransfer,getTargetRanges(),inputType,isComposing",
            ...
            FF78 = "constructor(),data,dataTransfer,getTargetRanges(),inputType,isComposing",
            IE = "exception")
