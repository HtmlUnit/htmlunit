...
public class HtmlTextAreaTest extends WebTestCase {
    ...
    private void formSubmission(final String textAreaText, final String expectedValue) throws Exception {
        ...
        assertEquals("url", URL_GARGOYLE + "?textArea1=" + expectedValue, secondPage.getWebResponse().getRequestUrl());
    ...
    public void testFormSubmission_NewValue() throws Exception {
        ...
        assertEquals("url", URL_GARGOYLE + "?textArea1=Flintstone", secondPage.getWebResponse().getRequestUrl());
        assertSame("method", HttpMethod.GET, webConnection.getLastMethod());
    }
    ...
    public void asText() throws Exception {
        ...
        final HtmlTextArea textArea = form.getTextAreaByName("textArea1");
        assertNotNull(textArea);
        Assert.assertEquals("White space must be preserved!", " foo " + LS + " bar <p>html snippet</p>" + LS, textArea.asText());
    }
