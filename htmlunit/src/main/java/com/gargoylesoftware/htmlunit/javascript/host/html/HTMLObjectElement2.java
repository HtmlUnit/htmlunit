 ...
 */
@ScriptClass
public class HTMLObjectElement2 extends HTMLElement2 {
     ...
     */
    public static HTMLObjectElement2 constructor(final boolean newObj, final Object self) {
        final HTMLObjectElement2 host = new HTMLObjectElement2();
    ...
    private static MethodHandle staticHandle(final String name, final Class<?> rtype, final Class<?>... ptypes) {
        try {
            return MethodHandles.lookup().findStatic(HTMLObjectElement2.class,
    ...
    public static final class FunctionConstructor extends ScriptFunction {
        ...
        public FunctionConstructor() {
            super("HTMLObjectElement",
                    staticHandle("constructor", HTMLObjectElement2.class, boolean.class, Object.class),
                    null);
