...
public class XMLHttpRequest2 extends EventTarget2 {
    ...
    @com.gargoylesoftware.js.nashorn.internal.objects.annotations.Property(attributes = Attribute.NOT_WRITABLE | Attribute.NOT_CONFIGURABLE, where = Where.CONSTRUCTOR)
    ...
    public String getResponseText() {
        ...
        if (webResponse_ != null) {
            ...
            if (getBrowserVersion().hasFeature(XHR_USE_DEFAULT_CHARSET_FROM_PAGE)) {
                defaultEncoding = ((HTMLDocument2) containingPage_.getScriptObject2()).getDefaultCharset();
            }
...
//            final Scriptable scope = stateChangeHandler_.getParentScope();
            final NashornJavaScriptEngine jsEngine = containingPage_.getWebClient().getJavaScriptEngine2();
...
//                        stack.pop();
     ...
     *                if {@code null}, the current thread's context is used.
     */
    private void processError(Global context) {
