 ...
 * @author Frank Danek
 */
public class HTMLCanvasElement2 extends HTMLElement2 {
     ...
     */
    public static HTMLCanvasElement2 constructor(final boolean newObj, final Object self) {
        final HTMLCanvasElement2 host = new HTMLCanvasElement2();
    ...
    private static MethodHandle staticHandle(final String name, final Class<?> rtype, final Class<?>... ptypes) {
        try {
            return MethodHandles.lookup().findStatic(HTMLCanvasElement2.class,
    ...
    public static final class FunctionConstructor extends ScriptFunction {
        ...
        public FunctionConstructor() {
            super("HTMLCanvasElement",
                    staticHandle("constructor", HTMLCanvasElement2.class, boolean.class, Object.class),
                    null);
