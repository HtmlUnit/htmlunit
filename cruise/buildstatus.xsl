	...
	<xsl:template match="/">
		...
		<rss version="2.0">
			<channel>
				...
				<title>htmlunit Build Status</title>

				<link>http://build.canooo.com/htmlunit/</link>

				<description>CruiseControl build status feed for the htmlunit project.</description>
				...
				<item>
					...
					<link>http://build.canoo.com/htmlunit/</link>
					<description>
						<xsl:choose>
